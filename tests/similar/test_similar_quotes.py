...
@pytest.fixture
def cached_recommendation_data():
    """
...
async def test_similar_quotes_endpoint(test_client, monkeypatch, mock_yahoo_auth):
...
async def test_fetch_yahoo_recommended_symbols(cached_recommendation_data, bypass_cache):
...
async def test_fetch_similar(cached_recommendation_data, cached_quote_data, bypass_cache):
...
async def test_fetch_similar_not_found(bypass_cache):
...
async def test_scrape_similar_quotes(cached_html_content, bypass_cache):
...
async def test_scrape_similar_quotes_invalid_symbol(bypass_cache):
...
async def test_get_similar_quotes_success(bypass_cache):
...
async def test_get_similar_quotes_fallback(bypass_cache):
...
async def test_get_similar_quotes_http_exception(bypass_cache):
