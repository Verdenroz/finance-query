...
async def test_websocket_profile(test_client, mock_yahoo_auth, monkeypatch):
...
async def test_websocket_quotes(test_client, mock_yahoo_auth):
...
async def test_websocket_market(test_client, mock_yahoo_auth, monkeypatch):
...
async def test_market_status_websocket(test_client, mock_yahoo_auth, monkeypatch):
...
async def test_handle_websocket_connection_invalid():
...
async def test_handle_websocket_connection_with_metadata():
...
async def test_handle_websocket_connection_disconnect_in_fetch_data():
