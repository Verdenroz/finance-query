...
class TestAnalysisData:
    ...
    def test_analysis_data_recommendations(self):
        ...
        recommendations = [
            RecommendationData(period="3m", strong_buy=5, buy=10, hold=3, sell=1, strong_sell=0)
        ]
    ...
    def test_analysis_data_price_targets(self):
        ...
        data = AnalysisData(
            symbol="AAPL",
            analysis_type=AnalysisType.PRICE_TARGETS,
    ...
    def test_analysis_data_earnings_estimate(self):
        ...
        data = AnalysisData(
            symbol="AAPL",
            analysis_type=AnalysisType.EARNINGS_ESTIMATE,
    ...
    def test_analysis_data_revenue_estimate(self):
        ...
        data = AnalysisData(
            symbol="AAPL",
            analysis_type=AnalysisType.REVENUE_ESTIMATE,
    ...
    def test_analysis_data_earnings_history(self):
        ...
        earnings_history = [
            EarningsHistoryItem(date=datetime(2024, 1, 15), eps_actual=2.18, eps_estimate=2.10, surprise=0.08, surprise_percent=3.8)
        ]
        
        data = AnalysisData(
            symbol="AAPL",
            analysis_type=AnalysisType.EARNINGS_HISTORY,
    ...
    def test_analysis_data_sustainability(self):
        ...
        data = AnalysisData(
            symbol="AAPL",
            analysis_type=AnalysisType.SUSTAINABILITY,
    ...
    def test_analysis_data_upgrades_downgrades(self):
        ...
        upgrades_downgrades = [
            UpgradeDowngrade(firm="Goldman Sachs", to_grade="Buy", from_grade="Hold", action="upgrade", date=datetime(2024, 1, 15))
        ]
        
        data = AnalysisData(
            symbol="AAPL",
            analysis_type=AnalysisType.UPGRADES_DOWNGRADES,
