...
class TestEarningsTranscriptRoutes:
    ...
    def test_post_earnings_transcript_analyze_endpoint(self, client):
        ...
        request_data = {"symbol": "AAPL", "quarter": "Q3", "year": 2024}
    ...
    def test_concurrent_requests(self, client):
        ...
        for _symbol, status_code in results:
    ...
    def test_endpoint_documentation_compliance(self, client):
        ...
        endpoints = ["/v1/earnings-transcript/AAPL", "/v1/earnings-transcript/AAPL/latest"]
