...
async def test_get_financials_income_annual(mock_client_class, client):
    ...
    mock_response = {
        ...
        "frequency": "annual",
        "statement": {"Total Revenue": {"2023-12-31": 1000, "2022-12-31": 900}, "Net Income": {"2023-12-31": 100, "2022-12-31": 90}},
        "metadata": {"source": "defeatbeta-api", "retrieved_at": "2024-09-14T11:53:14", "rows_count": 2, "columns_count": 2},
    }
...
async def test_get_financials_balance_sheet_quarterly(mock_client_class, client):
    ...
    mock_response = {
        ...
        "frequency": "quarterly",
        "statement": {"Total Assets": {"2024-03-31": 2000, "2023-12-31": 1900}, "Total Liabilities": {"2024-03-31": 1000, "2023-12-31": 950}},
        "metadata": {"source": "defeatbeta-api", "retrieved_at": "2024-09-14T11:53:14", "rows_count": 2, "columns_count": 2},
    }
...
async def test_get_financials_cash_flow(mock_client_class, client):
    ...
    mock_response = {
        ...
        "frequency": "annual",
        "statement": {"Operating Cash Flow": {"2023-12-31": 500}, "Capital Expenditure": {"2023-12-31": -50}},
        "metadata": {"source": "defeatbeta-api", "retrieved_at": "2024-09-14T11:53:14", "rows_count": 2, "columns_count": 1},
    }
...
async def test_get_financials_empty_data(mock_client_class, client):
    ...
    mock_response = {
        ...
        "metadata": {"source": "defeatbeta-api", "retrieved_at": "2024-09-14T11:53:14", "rows_count": 0, "columns_count": 0},
    }
