...
class TestCustomJSONFormatter:
    def test_add_fields(self):
        ...
        record = logging.LogRecord(name="test.module", level=logging.INFO, pathname="/path/to/module.py", lineno=0, msg="test message", args=(), exc_info=None)
    ...
    def test_add_fields_without_correlation_id(self):
        ...
        formatter = CustomJSONFormatter()
        record = logging.LogRecord(name="test.module", level=logging.ERROR, pathname="/path/to/module.py", lineno=0, msg="test message", args=(), exc_info=None)
        record.module = "module"  # Set module attribute explicitly
