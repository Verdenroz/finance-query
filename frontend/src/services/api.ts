...
// Use empty string to make API calls relative to current domain (via Nginx proxy)
// In production: requests go to http://yourdomain.com/v1/...
// In development: requests go to http://localhost:8080/v1/...
