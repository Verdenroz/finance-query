...
class Quote(BaseModel):
    ...
    open: Optional[str] = Field(default=None, examples=["144.00"], description="Opening price of the stock")
    high: Optional[str] = Field(default=None, examples=["146.00"], description="Highest day price of the stock")
    low: Optional[str] = Field(default=None, examples=["143.00"], description="Lowest day price of the stock")
    ...
    volume: Optional[int] = Field(default=None, examples=[1000000], description="Volume of the stock")
    ...
    beta: Optional[str] = Field(default=None, examples=[1.23], description="Beta of the stock")
    pe: Optional[str] = Field(default=None, examples=["30.00"], description="Price to earnings ratio of the stock")
    eps: Optional[str] = Field(default=None, examples=["4.50"], description="Earnings per share of the stock")
    dividend: Optional[str] = Field(default=None, examples=["0.82"], description="Dividend yield of the stock")
    ...
    nav: Optional[str] = Field(default=None, examples=["100.00"], description="Net asset value of the stock")
    ...
    category: Optional[str] = Field(default=None, examples=["Large Growth"], description="Category of the fund")
