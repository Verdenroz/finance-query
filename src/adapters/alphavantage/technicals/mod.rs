...
pub async fn technical_indicator(
    ...
    let mut data: Vec<IndicatorDataPointDTO> = analysis
        .iter()
...
pub async fn stoch(symbol: &str, interval: AvInterval) -> Result<TechnicalIndicatorDTO> {
    technical_indicator("STOCH", symbol, interval, &[]).await
}

/// Stochastic Fast (STOCHF).
pub async fn stochf(symbol: &str, interval: AvInterval) -> Result<TechnicalIndicatorDTO> {
...
pub async fn bop(symbol: &str, interval: AvInterval) -> Result<TechnicalIndicatorDTO> {
...
/// True Range (TRANGE).
pub async fn trange(symbol: &str, interval: AvInterval) -> Result<TechnicalIndicatorDTO> {
    technical_indicator("TRANGE", symbol, interval, &[]).await
}

/// Chaikin A/D Line (AD).
pub async fn ad(symbol: &str, interval: AvInterval) -> Result<TechnicalIndicatorDTO> {
    technical_indicator("AD", symbol, interval, &[]).await
}

/// Chaikin A/D Oscillator (ADOSC).
pub async fn adosc(symbol: &str, interval: AvInterval) -> Result<TechnicalIndicatorDTO> {
    technical_indicator("ADOSC", symbol, interval, &[]).await
}

/// On Balance Volume (OBV).
pub async fn obv(symbol: &str, interval: AvInterval) -> Result<TechnicalIndicatorDTO> {
...
/// Parabolic SAR (SAR).
pub async fn sar(symbol: &str, interval: AvInterval) -> Result<TechnicalIndicatorDTO> {
...
pub async fn ultosc(symbol: &str, interval: AvInterval) -> Result<TechnicalIndicatorDTO> {
    technical_indicator("ULTOSC", symbol, interval, &[]).await
}

/// Volume Weighted Average Price (VWAP).
pub async fn vwap(symbol: &str, interval: AvInterval) -> Result<TechnicalIndicatorDTO> {
