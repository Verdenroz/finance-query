...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[non_exhaustive]
pub struct DiscountedCashFlowDTO {
    /// Ticker symbol.
    pub symbol: Option<String>,
    /// Date.
    pub date: Option<String>,
...
pub async fn historical_rating(symbol: &str, limit: Option<u32>) -> Result<Vec<CompanyRatingDTO>> {
    let client = crate::adapters::fmp::build_client()?;
