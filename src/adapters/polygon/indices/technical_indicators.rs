...
pub async fn index_sma(ticker: &str, params: &[(&str, &str)]) -> Result<IndicatorResponseDTO> {
...
/// * `ticker` - Index ticker symbol with `I:` prefix (e.g., `"I:SPX"`)
/// * `params` - Optional query params: `window`, `timespan`, `series_type`, `order`, `limit`
pub async fn index_ema(ticker: &str, params: &[(&str, &str)]) -> Result<IndicatorResponseDTO> {
...
pub async fn index_macd(ticker: &str, params: &[(&str, &str)]) -> Result<IndicatorResponseDTO> {
...
/// * `ticker` - Index ticker symbol with `I:` prefix (e.g., `"I:SPX"`)
/// * `params` - Optional query params: `window`, `timespan`, `series_type`, `order`, `limit`
pub async fn index_rsi(ticker: &str, params: &[(&str, &str)]) -> Result<IndicatorResponseDTO> {
...
async fn fetch_indicator(
    ...
    client
        .get_as(
            ...
            params,
            indicator,
            &format!("index {indicator} response"),
        )
        .await
}
