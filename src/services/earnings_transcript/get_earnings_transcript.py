...
async def get_earnings_transcript(symbol: str, quarter: Optional[str] = None, year: Optional[int] = None) -> dict[str, Any]:
    """
    ...
    try:
        ...
        transcript_data = await defeatbeta_client.get_earnings_transcript(symbol=symbol, quarter=quarter, year=year)
        ...
        return {
            ...
            "metadata": {
                ...
                "filters_applied": {"quarter": quarter, "year": year},
