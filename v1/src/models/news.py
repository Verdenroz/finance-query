...
class News(BaseModel):
    ...
    img: str = Field(default=..., examples=["https://www.example.com/image.jpg"], description="Image of the news article")
    time: str = Field(default=..., examples=["1 day ago"], description="Time relative to current time when the news was published")
