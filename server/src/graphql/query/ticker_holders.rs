...
impl TickerHoldersQuery {
    async fn major_holders(&self, ctx: &Context<'_>) -> Result<GqlMajorHoldersBreakdown> {
        ...
        exec_gql(crate::services::holders::get_major_holders(
            &state.cache,
            &self.symbol,
        ))
        .await
    ...
    async fn institutional_holders(&self, ctx: &Context<'_>) -> Result<GqlInstitutionOwnership> {
        let state = ctx.data::<AppState>()?;
        exec_gql(crate::services::holders::get_institutional_holders(
            &state.cache,
            &self.symbol,
        ))
        .await
    ...
    async fn mutual_fund_holders(&self, ctx: &Context<'_>) -> Result<GqlFundOwnership> {
        let state = ctx.data::<AppState>()?;
        exec_gql(crate::services::holders::get_mutual_fund_holders(
            &state.cache,
            &self.symbol,
        ))
        .await
    ...
    async fn insider_transactions(&self, ctx: &Context<'_>) -> Result<GqlInsiderTransactions> {
        let state = ctx.data::<AppState>()?;
        exec_gql(crate::services::holders::get_insider_transactions(
            &state.cache,
            &self.symbol,
        ))
        .await
    ...
    async fn insider_purchases(&self, ctx: &Context<'_>) -> Result<GqlNetSharePurchaseActivity> {
        let state = ctx.data::<AppState>()?;
        exec_gql(crate::services::holders::get_insider_purchases(
            &state.cache,
            &self.symbol,
        ))
        .await
    ...
    async fn insider_roster(&self, ctx: &Context<'_>) -> Result<GqlInsiderHolders> {
        let state = ctx.data::<AppState>()?;
        exec_gql(crate::services::holders::get_insider_roster(
            &state.cache,
            &self.symbol,
        ))
        .await
