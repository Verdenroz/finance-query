...
pub use finance_query_server::graphql::fields::{
    ...
    GQL_COMMODITY_QUOTE_VALID_FIELDS, GQL_COMPANY_PROFILE_VALID_FIELDS,
    GQL_CONGRESSIONAL_TRADE_VALID_FIELDS, GQL_DIVIDENDS_VALID_FIELDS,
    ...
    GQL_EARNINGS_SURPRISES_COMPOSITE, GQL_EARNINGS_SURPRISES_VALID_FIELDS,
    GQL_EARNINGS_TRANSCRIPT_VALID_FIELDS, GQL_EDGAR_FACTS_VALID_FIELDS,
    GQL_EDGAR_SUBMISSIONS_VALID_FIELDS, GQL_ETF_COUNTRY_WEIGHTING_COMPOSITE,
    GQL_ETF_HOLDING_COMPOSITE, GQL_ETF_PROFILE_VALID_FIELDS, GQL_ETF_SECTOR_WEIGHTING_COMPOSITE,
    GQL_FAIL_TO_DELIVER_VALID_FIELDS, GQL_FEAR_AND_GREED_VALID_FIELDS, GQL_FEEDS_VALID_FIELDS,
    GQL_FILING_SECTION_VALID_FIELDS, GQL_FUTURES_QUOTE_VALID_FIELDS, GQL_GRADING_HISTORY_COMPOSITE,
    GQL_GRADING_HISTORY_VALID_FIELDS, GQL_INDEX_CONSTITUENT_VALID_FIELDS,
    GQL_INDICATORS_VALID_FIELDS, GQL_INDUSTRY_VALID_FIELDS, GQL_INSIDER_PURCHASES_VALID_FIELDS,
    GQL_INSIDER_ROSTER_COMPOSITE, GQL_INSIDER_ROSTER_VALID_FIELDS,
    GQL_INSIDER_TRANSACTIONS_COMPOSITE, GQL_INSIDER_TRANSACTIONS_VALID_FIELDS,
    GQL_INSTITUTIONAL_HOLDERS_VALID_FIELDS, GQL_LOOKUP_RESULTS_VALID_FIELDS,
    GQL_MACRO_SERIES_VALID_FIELDS, GQL_MAJOR_HOLDERS_VALID_FIELDS,
    GQL_MARKET_CALENDAR_VALID_FIELDS, GQL_MARKET_HOURS_VALID_FIELDS,
    GQL_MARKET_SECTOR_PE_VALID_FIELDS, GQL_MARKET_SECTOR_PERFORMANCE_VALID_FIELDS,
    GQL_MARKET_SUMMARY_VALID_FIELDS, GQL_MUTUAL_FUND_HOLDERS_VALID_FIELDS, GQL_NEWS_VALID_FIELDS,
    GQL_OPTIONS_VALID_FIELDS, GQL_OWNER_FIELDS, GQL_PRESS_RELEASE_VALID_FIELDS,
    GQL_PRICE_TARGET_CONSENSUS_VALID_FIELDS, GQL_QUOTE_VALID_FIELDS,
    GQL_RATING_CONSENSUS_VALID_FIELDS, GQL_RECOMMENDATION_TREND_COMPOSITE,
    GQL_RECOMMENDATION_TREND_VALID_FIELDS, GQL_RECOMMENDATION_VALID_FIELDS,
    GQL_RISK_FACTOR_VALID_FIELDS, GQL_SCREENER_RESULTS_VALID_FIELDS,
    GQL_SEARCH_RESULTS_VALID_FIELDS, GQL_SECTOR_VALID_FIELDS, GQL_SPARK_VALID_FIELDS,
    GQL_SPLIT_VALID_FIELDS, GQL_TRANSCRIPT_VALID_FIELDS, GQL_TREASURY_YIELD_VALID_FIELDS,
    GQL_TRENDING_VALID_FIELDS, INDICATOR_COMPOSITE_FIELDS, INDUSTRY_COMPOSITE_FIELDS,
    LOOKUP_RESULTS_COMPOSITE_FIELDS, MACRO_SERIES_COMPOSITE_FIELDS,
    MARKET_CALENDAR_DETAIL_UNION_SELECTION, MARKET_HOURS_COMPOSITE_FIELDS, NEWS_COMPOSITE_FIELDS,
    OPTIONS_COMPOSITE_FIELDS, RECOMMENDATION_COMPOSITE_FIELDS, SCREENER_RESULTS_COMPOSITE_FIELDS,
...
// ── Company profile / earnings surprises / earnings transcript ─────────────
//
// Each is a single fixed ticker-scoped field (not selected via a type-dispatch
// enum like `AnalysisType`), so they get their own MCP tool rather than a
// `TypeSpec` table entry.

pub const GQL_COMPANY_PROFILE_DEFAULT_FIELDS: &[&str] = GQL_COMPANY_PROFILE_VALID_FIELDS;
pub const GQL_EARNINGS_SURPRISES_DEFAULT_FIELDS: &[&str] = GQL_EARNINGS_SURPRISES_VALID_FIELDS;
pub const GQL_EARNINGS_TRANSCRIPT_DEFAULT_FIELDS: &[&str] = GQL_EARNINGS_TRANSCRIPT_VALID_FIELDS;
pub const GQL_RATING_CONSENSUS_DEFAULT_FIELDS: &[&str] = GQL_RATING_CONSENSUS_VALID_FIELDS;
pub const GQL_PRICE_TARGET_CONSENSUS_DEFAULT_FIELDS: &[&str] =
    GQL_PRICE_TARGET_CONSENSUS_VALID_FIELDS;
pub const GQL_ETF_PROFILE_DEFAULT_FIELDS: &[&str] = GQL_ETF_PROFILE_VALID_FIELDS;

/// Default fields for MCP `get_congressional_trades`/`get_fails_to_deliver`
/// (all fields; both types are tiny).
pub const GQL_CONGRESSIONAL_TRADE_DEFAULT_FIELDS: &[&str] = GQL_CONGRESSIONAL_TRADE_VALID_FIELDS;
pub const GQL_FAIL_TO_DELIVER_DEFAULT_FIELDS: &[&str] = GQL_FAIL_TO_DELIVER_VALID_FIELDS;
pub const GQL_FILING_SECTION_DEFAULT_FIELDS: &[&str] = GQL_FILING_SECTION_VALID_FIELDS;
pub const GQL_COMMODITY_QUOTE_DEFAULT_FIELDS: &[&str] = GQL_COMMODITY_QUOTE_VALID_FIELDS;
pub const GQL_FUTURES_QUOTE_DEFAULT_FIELDS: &[&str] = GQL_FUTURES_QUOTE_VALID_FIELDS;
pub const GQL_INDEX_CONSTITUENT_DEFAULT_FIELDS: &[&str] = GQL_INDEX_CONSTITUENT_VALID_FIELDS;
pub const GQL_RISK_FACTOR_DEFAULT_FIELDS: &[&str] = GQL_RISK_FACTOR_VALID_FIELDS;
pub const GQL_PRESS_RELEASE_DEFAULT_FIELDS: &[&str] = GQL_PRESS_RELEASE_VALID_FIELDS;
...
pub const GQL_MARKET_SECTOR_PERFORMANCE_DEFAULT_FIELDS: &[&str] =
    GQL_MARKET_SECTOR_PERFORMANCE_VALID_FIELDS;
pub const GQL_MARKET_SECTOR_PE_DEFAULT_FIELDS: &[&str] = GQL_MARKET_SECTOR_PE_VALID_FIELDS;
...
pub fn build_union_selection(
    ...
    if !chosen.contains(&union_field) {
        return build_selection_all(&chosen);
    }
