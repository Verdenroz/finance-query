...
pub use finance_query_server::graphql::fields::{
    ...
    GQL_FILING_SECTION_VALID_FIELDS, GQL_FOREX_QUOTE_VALID_FIELDS, GQL_FUTURES_QUOTE_VALID_FIELDS,
    GQL_GRADING_HISTORY_COMPOSITE, GQL_GRADING_HISTORY_VALID_FIELDS,
    GQL_INDEX_CONSTITUENT_VALID_FIELDS, GQL_INDICATORS_VALID_FIELDS, GQL_INDUSTRY_VALID_FIELDS,
...
pub const GQL_FOREX_QUOTE_DEFAULT_FIELDS: &[&str] = GQL_FOREX_QUOTE_VALID_FIELDS;
