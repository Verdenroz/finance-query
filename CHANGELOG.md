...
|---|---:|---:|---:|---:|---:|
| `finance_query::bt_base_to_htf_index` | n/a | 30.39µs | 37.25µs | 1 | n/a |
| `finance_query::bt_bayesian_search` | n/a | 3.02ms | 3.13ms | 2382 | n/a |
| `finance_query::bt_grid_search` | n/a | 642.62µs | 760.42µs | 3012 | n/a |
| `finance_query::bt_monte_carlo` | n/a | 179.00µs | 184.47µs | 6 | n/a |
| `finance_query::bt_resample` | n/a | 109.53µs | 112.03µs | 11 | n/a |
| `finance_query::bt_sma_crossover` | n/a | 925.11µs | 944.58µs | 2373 | n/a |
| `finance_query::bt_strategy_builder` | n/a | 162.77µs | 168.77µs | 330 | n/a |
| `finance_query::capability_name` | n/a | 3.1ns | 3.4ns | 0 | n/a |
| `finance_query::cond_bench_always_false` | n/a | 18.47µs | 18.70µs | 6 | n/a |
| `finance_query::cond_bench_always_true` | n/a | 401.56µs | 404.92µs | 4045 | n/a |
| `finance_query::cond_bench_has_position` | n/a | 402.55µs | 418.22µs | 4045 | n/a |
| `finance_query::cond_bench_held_for_bars` | n/a | 154.50µs | 166.60µs | 1041 | n/a |
| `finance_query::cond_bench_in_loss` | n/a | 418.69µs | 437.02µs | 4045 | n/a |
| `finance_query::cond_bench_in_profit` | n/a | 47.11µs | 48.47µs | 142 | n/a |
| `finance_query::cond_bench_is_long` | n/a | 404.96µs | 435.39µs | 4045 | n/a |
| `finance_query::cond_bench_is_short` | n/a | 32.08µs | 35.16µs | 13 | n/a |
| `finance_query::cond_bench_no_position` | n/a | 32.26µs | 32.66µs | 13 | n/a |
| `finance_query::cond_bench_stop_loss` | n/a | 40.15µs | 69.57µs | 24 | n/a |
| `finance_query::cond_bench_take_profit` | n/a | 39.28µs | 40.29µs | 13 | n/a |
| `finance_query::cond_bench_trailing_stop` | n/a | 49.21µs | 50.41µs | 92 | n/a |
| `finance_query::cond_bench_trailing_take_profit` | n/a | 47.42µs | 49.81µs | 72 | n/a |
| `finance_query::de_chart` | n/a | 9.45µs | 12.83µs | 13 | n/a |
| `finance_query::de_crypto_coins` | n/a | 33.22µs | 34.43µs | 205 | n/a |
| `finance_query::de_currencies` | n/a | 55.68µs | 58.07µs | 647 | n/a |
| `finance_query::de_edgar_facts` | n/a | 1.38ms | 1.42ms | 11899 | n/a |
| `finance_query::de_edgar_submissions` | n/a | 452.19µs | 465.54µs | 6784 | n/a |
| `finance_query::de_fear_and_greed` | n/a | 111.7ns | 123.7ns | 0 | n/a |
| `finance_query::de_fear_and_greed_crypto_history` | n/a | 1.34µs | 1.40µs | 3 | n/a |
| `finance_query::de_financials` | n/a | 20.74µs | 22.81µs | 206 | n/a |
| `finance_query::de_fred_series` | n/a | 104.66µs | 111.30µs | 873 | n/a |
| `finance_query::de_hours` | n/a | 716.6ns | 728.8ns | 10 | n/a |
| `finance_query::de_market_summary` | n/a | 32.17µs | 32.86µs | 228 | n/a |
| `finance_query::de_news` | n/a | 3.84µs | 4.03µs | 53 | n/a |
| `finance_query::de_options` | n/a | 1.12µs | 1.20µs | 6 | n/a |
| `finance_query::de_quote` | n/a | 1.03ms | 1.07ms | 8235 | n/a |
| `finance_query::de_screener` | n/a | 431.90µs | 442.64µs | 4498 | n/a |
| `finance_query::de_search` | n/a | 5.04µs | 5.35µs | 55 | n/a |
| `finance_query::de_treasury_yields` | n/a | 78.79µs | 81.02µs | 119 | n/a |
| `finance_query::de_trending` | n/a | 1.44µs | 1.50µs | 24 | n/a |
| `finance_query::dispatch_select` | n/a | 4.0ns | 5.4ns | 0 | n/a |
| `finance_query::ind_accumulation_distribution` | n/a | 3.82µs | 3.87µs | 1 | n/a |
| `finance_query::ind_alma` | n/a | 5.18µs | 5.22µs | 2 | n/a |
| `finance_query::ind_aroon` | n/a | 12.98µs | 14.62µs | 9 | n/a |
| `finance_query::ind_atr` | n/a | 9.62µs | 9.68µs | 2 | n/a |
| `finance_query::ind_awesome_oscillator` | n/a | 8.50µs | 8.59µs | 4 | n/a |
| `finance_query::ind_balance_of_power` | n/a | 1.91µs | 1.92µs | 2 | n/a |
| `finance_query::ind_bull_bear_power` | n/a | 7.02µs | 7.11µs | 3 | n/a |
| `finance_query::ind_cci` | n/a | 17.16µs | 17.49µs | 2 | n/a |
| `finance_query::ind_chaikin_oscillator` | n/a | 15.96µs | 16.72µs | 4 | n/a |
| `finance_query::ind_choppiness_index` | n/a | 22.11µs | 22.44µs | 8 | n/a |
| `finance_query::ind_cmf` | n/a | 3.89µs | 3.94µs | 2 | n/a |
| `finance_query::ind_cmo` | n/a | 5.03µs | 5.54µs | 2 | n/a |
| `finance_query::ind_coppock_curve` | n/a | 7.65µs | 8.39µs | 3 | n/a |
| `finance_query::ind_dema` | n/a | 11.84µs | 11.89µs | 3 | n/a |
| `finance_query::ind_donchian_channels` | n/a | 11.81µs | 12.19µs | 9 | n/a |
| `finance_query::ind_elder_ray` | n/a | 7.06µs | 7.17µs | 3 | n/a |
| `finance_query::ind_fibonacci_pivot_points` | n/a | 2.38µs | 2.41µs | 1 | n/a |
| `finance_query::ind_fibonacci_retracement` | n/a | 11.47µs | 12.04µs | 9 | n/a |
| `finance_query::ind_heikin_ashi` | n/a | 14.51µs | 14.89µs | 9 | n/a |
| `finance_query::ind_hma` | n/a | 13.78µs | 13.92µs | 5 | n/a |
| `finance_query::ind_ichimoku` | n/a | 36.56µs | 37.54µs | 27 | n/a |
| `finance_query::ind_keltner_channels` | n/a | 17.16µs | 17.32µs | 5 | n/a |
| `finance_query::ind_last_value` | n/a | 2.8ns | 3.4ns | 0 | n/a |
| `finance_query::ind_macd` | n/a | 20.05µs | 20.24µs | 7 | n/a |
| `finance_query::ind_mcginley_dynamic` | n/a | 12.04µs | 12.17µs | 1 | n/a |
| `finance_query::ind_mfi` | n/a | 7.23µs | 7.67µs | 3 | n/a |
| `finance_query::ind_momentum` | n/a | 122.96µs | 127.58µs | 52 | n/a |
| `finance_query::ind_momentum_single` | n/a | 529.9ns | 550.7ns | 1 | n/a |
| `finance_query::ind_moving_averages` | n/a | 85.75µs | 90.57µs | 27 | n/a |
| `finance_query::ind_parabolic_sar` | n/a | 2.30µs | 2.36µs | 1 | n/a |
| `finance_query::ind_patterns` | n/a | 101.18µs | 103.32µs | 1 | n/a |
| `finance_query::ind_pivot_points` | n/a | 2.85µs | 2.89µs | 1 | n/a |
| `finance_query::ind_roc` | n/a | 1.64µs | 1.72µs | 1 | n/a |
| `finance_query::ind_sma` | n/a | 377.90µs | 383.89µs | 1 | n/a |
| `finance_query::ind_stochastic` | n/a | 16.32µs | 16.55µs | 11 | n/a |
| `finance_query::ind_stochastic_rsi` | n/a | 27.36µs | 28.37µs | 12 | n/a |
| `finance_query::ind_supertrend` | n/a | 13.26µs | 13.58µs | 4 | n/a |
| `finance_query::ind_tema` | n/a | 17.55µs | 17.69µs | 4 | n/a |
| `finance_query::ind_trend` | n/a | 95.03µs | 100.58µs | 48 | n/a |
| `finance_query::ind_true_range` | n/a | 1.24µs | 1.31µs | 1 | n/a |
| `finance_query::ind_volatility` | n/a | 68.50µs | 69.73µs | 28 | n/a |
| `finance_query::ind_volume` | n/a | 40.51µs | 41.64µs | 14 | n/a |
| `finance_query::ind_vwap` | n/a | 3.87µs | 3.94µs | 1 | n/a |
| `finance_query::ind_vwma` | n/a | 3.08µs | 3.25µs | 1 | n/a |
| `finance_query::ind_williams_r` | n/a | 11.04µs | 11.44µs | 7 | n/a |
| `finance_query::ind_wma` | n/a | 4.59µs | 4.68µs | 7 | n/a |
| `finance_query::ind_zigzag` | n/a | 1.90µs | 1.98µs | 4 | n/a |
| `finance_query::ref_bench_accumulation_distribution` | n/a | 48.82µs | 49.24µs | 23 | n/a |
| `finance_query::ref_bench_adx` | n/a | 513.91µs | 530.46µs | 4930 | n/a |
| `finance_query::ref_bench_alma` | n/a | 555.16µs | 588.54µs | 5019 | n/a |
| `finance_query::ref_bench_aroon` | n/a | 516.32µs | 530.91µs | 4950 | n/a |
| `finance_query::ref_bench_atr` | n/a | 510.34µs | 550.12µs | 4996 | n/a |
| `finance_query::ref_bench_awesome_oscillator` | n/a | 312.80µs | 322.05µs | 2636 | n/a |
| `finance_query::ref_bench_balance_of_power` | n/a | 47.33µs | 47.87µs | 25 | n/a |
| `finance_query::ref_bench_bear_power` | n/a | 142.03µs | 155.67µs | 806 | n/a |
| `finance_query::ref_bench_bollinger` | n/a | 557.69µs | 592.05µs | 4968 | n/a |
| `finance_query::ref_bench_bull_power` | n/a | 481.09µs | 495.05µs | 4238 | n/a |
| `finance_query::ref_bench_candle_body` | n/a | 21.78µs | 24.89µs | 6 | n/a |
| `finance_query::ref_bench_candle_range` | n/a | 483.10µs | 493.66µs | 5043 | n/a |
| `finance_query::ref_bench_cci` | n/a | 302.31µs | 315.79µs | 2605 | n/a |
| `finance_query::ref_bench_chaikin_oscillator` | n/a | 63.89µs | 65.71µs | 26 | n/a |
| `finance_query::ref_bench_choppiness_index` | n/a | 526.69µs | 543.95µs | 5002 | n/a |
| `finance_query::ref_bench_close` | n/a | 476.44µs | 501.16µs | 5043 | n/a |
| `finance_query::ref_bench_cmf` | n/a | 49.17µs | 50.03µs | 25 | n/a |
| `finance_query::ref_bench_cmo` | n/a | 289.91µs | 312.72µs | 2598 | n/a |
| `finance_query::ref_bench_coppock_curve` | n/a | 311.16µs | 325.54µs | 2559 | n/a |
| `finance_query::ref_bench_dema` | n/a | 507.72µs | 577.59µs | 4875 | n/a |
| `finance_query::ref_bench_donchian` | n/a | 569.12µs | 588.43µs | 4976 | n/a |
| `finance_query::ref_bench_elder_bear_power` | n/a | 144.79µs | 148.52µs | 806 | n/a |
| `finance_query::ref_bench_elder_bull_power` | n/a | 483.86µs | 500.10µs | 4238 | n/a |
| `finance_query::ref_bench_ema` | n/a | 501.07µs | 529.41µs | 4963 | n/a |
| `finance_query::ref_bench_gap_pct` | n/a | 256.20µs | 263.96µs | 2489 | n/a |
| `finance_query::ref_bench_high` | n/a | 476.63µs | 499.99µs | 5043 | n/a |
| `finance_query::ref_bench_hma` | n/a | 511.70µs | 571.79µs | 4957 | n/a |
| `finance_query::ref_bench_htf` | n/a | 603.93µs | 623.98µs | 7039 | n/a |
| `finance_query::ref_bench_htf_region` | n/a | 605.62µs | 644.82µs | 7039 | n/a |
| `finance_query::ref_bench_ichimoku` | n/a | 597.82µs | 699.99µs | 4836 | n/a |
| `finance_query::ref_bench_ichimoku_custom` | n/a | 596.99µs | 610.09µs | 4836 | n/a |
| `finance_query::ref_bench_is_bearish` | n/a | 21.95µs | 24.54µs | 6 | n/a |
| `finance_query::ref_bench_is_bullish` | n/a | 22.00µs | 24.43µs | 6 | n/a |
| `finance_query::ref_bench_keltner` | n/a | 574.06µs | 605.18µs | 4972 | n/a |
| `finance_query::ref_bench_low` | n/a | 495.29µs | 521.31µs | 5043 | n/a |
| `finance_query::ref_bench_macd` | n/a | 322.10µs | 406.36µs | 2541 | n/a |
| `finance_query::ref_bench_mcginley` | n/a | 510.50µs | 545.00µs | 4963 | n/a |
| `finance_query::ref_bench_median_price` | n/a | 481.45µs | 494.16µs | 5043 | n/a |
| `finance_query::ref_bench_mfi` | n/a | 510.01µs | 520.06µs | 4998 | n/a |
| `finance_query::ref_bench_momentum` | n/a | 282.41µs | 296.06µs | 2552 | n/a |
| `finance_query::ref_bench_obv` | n/a | 58.29µs | 58.64µs | 30 | n/a |
| `finance_query::ref_bench_open` | n/a | 483.41µs | 496.11µs | 5043 | n/a |
| `finance_query::ref_bench_parabolic_sar` | n/a | 562.13µs | 584.46µs | 5056 | n/a |
| `finance_query::ref_bench_price` | n/a | 474.28µs | 489.48µs | 5043 | n/a |
| `finance_query::ref_bench_price_change_pct` | n/a | 278.54µs | 290.66µs | 2489 | n/a |
| `finance_query::ref_bench_relative_volume` | n/a | 525.19µs | 551.46µs | 4949 | n/a |
| `finance_query::ref_bench_roc` | n/a | 281.91µs | 285.78µs | 2587 | n/a |
| `finance_query::ref_bench_rsi` | n/a | 503.77µs | 529.80µs | 4994 | n/a |
| `finance_query::ref_bench_sma` | n/a | 495.98µs | 505.03µs | 4963 | n/a |
| `finance_query::ref_bench_stochastic` | n/a | 567.24µs | 581.07µs | 4987 | n/a |
| `finance_query::ref_bench_stochastic_rsi` | n/a | 567.82µs | 592.17µs | 4831 | n/a |
| `finance_query::ref_bench_supertrend` | n/a | 562.74µs | 594.19µs | 5021 | n/a |
| `finance_query::ref_bench_tema` | n/a | 504.52µs | 510.28µs | 4781 | n/a |
| `finance_query::ref_bench_true_range` | n/a | 514.38µs | 521.05µs | 5059 | n/a |
| `finance_query::ref_bench_typical_price` | n/a | 519.53µs | 536.97µs | 5043 | n/a |
| `finance_query::ref_bench_volume` | n/a | 479.07µs | 497.86µs | 5043 | n/a |
| `finance_query::ref_bench_vwap` | n/a | 519.55µs | 534.04µs | 5060 | n/a |
| `finance_query::ref_bench_vwma` | n/a | 499.17µs | 521.10µs | 4964 | n/a |
| `finance_query::ref_bench_williams_r` | n/a | 58.56µs | 62.65µs | 29 | n/a |
| `finance_query::ref_bench_wma` | n/a | 495.61µs | 529.79µs | 4969 | n/a |
| `finance_query::risk_beta` | n/a | 61.23µs | 61.65µs | 0 | n/a |
| `finance_query::risk_calmar` | n/a | 16.3ns | 16.9ns | 0 | n/a |
| `finance_query::risk_historical_cvar` | n/a | 338.81µs | 346.24µs | 2 | n/a |
| `finance_query::risk_historical_var` | n/a | 2.57ms | 2.59ms | 2 | n/a |
| `finance_query::risk_information_ratio` | n/a | 36.17µs | 36.45µs | 1 | n/a |
| `finance_query::risk_kelly_criterion` | n/a | 3.75µs | 3.77µs | 16 | n/a |
| `finance_query::risk_max_drawdown` | n/a | 8.02µs | 8.16µs | 1 | n/a |
| `finance_query::risk_omega_ratio` | n/a | 30.57µs | 30.71µs | 0 | n/a |
| `finance_query::risk_parametric_cvar` | n/a | 30.61µs | 30.75µs | 0 | n/a |
| `finance_query::risk_parametric_var` | n/a | 30.60µs | 30.86µs | 0 | n/a |
| `finance_query::risk_sharpe` | n/a | 30.60µs | 30.87µs | 0 | n/a |
| `finance_query::risk_sortino` | n/a | 30.59µs | 30.77µs | 0 | n/a |
| `finance_query::risk_tracking_error` | n/a | 36.08µs | 36.84µs | 1 | n/a |
| `finance_query::risk_ulcer_index` | n/a | 174.69µs | 176.54µs | 2 | n/a |
| `finance_query::risk_win_loss_stats` | n/a | 160.92µs | 177.67µs | 25 | n/a |
| `finance_query::rss_parse` | n/a | 5.90µs | 6.06µs | 48 | n/a |
| `finance_query::score_news` | n/a | 87.06µs | 97.71µs | 976 | n/a |
| `finance_query::score_transcript` | n/a | 4.73ms | 4.81ms | 42100 | n/a |
| `finance_query::ser_currencies` | n/a | 19.57µs | 20.28µs | 8 | n/a |
| `finance_query::stream_deserialize` | n/a | 1.21µs | 1.25µs | 4 | n/a |
| `finance_query::stream_serialize` | n/a | 1.06µs | 1.09µs | 4 | n/a |
| `finance_query::ticker_chart_then_cached` | n/a | 1.29µs | 1.30µs | 20 | n/a |
| `finance_query::ticker_quote_then_cached` | n/a | 12.19µs | 12.55µs | 4 | n/a |
| `finance_query::tickers_batch_quote_then_cached` | n/a | 9.57µs | 9.91µs | 16 | n/a |
| `finance_query::translate_dictionary` | n/a | 1.88µs | 1.89µs | 49 | n/a |
| `finance_query::translation_set_backend` | n/a | 21.3ns | 26.5ns | 1 | n/a |
| `finance_query::translation_translate` | n/a | 3.63µs | 3.70µs | 79 | n/a |
| `finance_query::translation_translate_with` | n/a | 3.42µs | 3.53µs | 77 | n/a |
