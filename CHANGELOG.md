...
|---|---:|---:|---:|---:|---:|
| `finance_query::bt_base_to_htf_index` | n/a | 27.10µs | 44.07µs | 1 | n/a |
| `finance_query::bt_bayesian_search` | n/a | 3.03ms | 3.12ms | 2382 | n/a |
| `finance_query::bt_grid_search` | n/a | 654.96µs | 775.39µs | 3012 | n/a |
| `finance_query::bt_monte_carlo` | n/a | 199.76µs | 205.37µs | 6 | n/a |
| `finance_query::bt_resample` | n/a | 108.84µs | 111.45µs | 11 | n/a |
| `finance_query::bt_sma_crossover` | n/a | 938.48µs | 977.23µs | 2373 | n/a |
| `finance_query::bt_strategy_builder` | n/a | 164.55µs | 173.04µs | 330 | n/a |
| `finance_query::capability_name` | n/a | 3.1ns | 3.6ns | 0 | n/a |
| `finance_query::cond_bench_always_false` | n/a | 18.88µs | 19.43µs | 6 | n/a |
| `finance_query::cond_bench_always_true` | n/a | 420.27µs | 432.71µs | 4045 | n/a |
| `finance_query::cond_bench_has_position` | n/a | 408.52µs | 419.16µs | 4045 | n/a |
| `finance_query::cond_bench_held_for_bars` | n/a | 156.17µs | 172.79µs | 1041 | n/a |
| `finance_query::cond_bench_in_loss` | n/a | 438.72µs | 447.31µs | 4045 | n/a |
| `finance_query::cond_bench_in_profit` | n/a | 47.11µs | 48.73µs | 142 | n/a |
| `finance_query::cond_bench_is_long` | n/a | 421.74µs | 431.88µs | 4045 | n/a |
| `finance_query::cond_bench_is_short` | n/a | 32.21µs | 32.31µs | 13 | n/a |
| `finance_query::cond_bench_no_position` | n/a | 32.40µs | 33.47µs | 13 | n/a |
| `finance_query::cond_bench_stop_loss` | n/a | 40.20µs | 43.51µs | 24 | n/a |
| `finance_query::cond_bench_take_profit` | n/a | 38.67µs | 39.20µs | 13 | n/a |
| `finance_query::cond_bench_trailing_stop` | n/a | 49.12µs | 51.68µs | 92 | n/a |
| `finance_query::cond_bench_trailing_take_profit` | n/a | 47.52µs | 48.67µs | 72 | n/a |
| `finance_query::de_chart` | n/a | 9.39µs | 9.97µs | 13 | n/a |
| `finance_query::de_crypto_coins` | n/a | 33.32µs | 33.88µs | 205 | n/a |
| `finance_query::de_currencies` | n/a | 54.28µs | 56.68µs | 647 | n/a |
| `finance_query::de_edgar_facts` | n/a | 1.39ms | 1.52ms | 11899 | n/a |
| `finance_query::de_edgar_submissions` | n/a | 456.21µs | 463.04µs | 6784 | n/a |
| `finance_query::de_fear_and_greed` | n/a | 111.1ns | 136.5ns | 0 | n/a |
| `finance_query::de_fear_and_greed_crypto_history` | n/a | 1.30µs | 1.33µs | 3 | n/a |
| `finance_query::de_financials` | n/a | 21.01µs | 21.17µs | 206 | n/a |
| `finance_query::de_fred_series` | n/a | 103.90µs | 109.19µs | 873 | n/a |
| `finance_query::de_hours` | n/a | 712.2ns | 788.6ns | 10 | n/a |
| `finance_query::de_market_summary` | n/a | 31.50µs | 32.41µs | 228 | n/a |
| `finance_query::de_news` | n/a | 3.78µs | 3.81µs | 53 | n/a |
| `finance_query::de_options` | n/a | 1.10µs | 1.15µs | 6 | n/a |
| `finance_query::de_quote` | n/a | 1.05ms | 1.08ms | 8235 | n/a |
| `finance_query::de_screener` | n/a | 433.08µs | 439.27µs | 4498 | n/a |
| `finance_query::de_search` | n/a | 5.09µs | 5.12µs | 55 | n/a |
| `finance_query::de_treasury_yields` | n/a | 80.61µs | 81.66µs | 119 | n/a |
| `finance_query::de_trending` | n/a | 1.44µs | 1.59µs | 24 | n/a |
| `finance_query::dispatch_select` | n/a | 4.0ns | 4.6ns | 0 | n/a |
| `finance_query::ind_accumulation_distribution` | n/a | 3.80µs | 3.84µs | 1 | n/a |
| `finance_query::ind_alma` | n/a | 5.17µs | 5.39µs | 2 | n/a |
| `finance_query::ind_aroon` | n/a | 13.11µs | 13.57µs | 9 | n/a |
| `finance_query::ind_atr` | n/a | 9.61µs | 9.82µs | 2 | n/a |
| `finance_query::ind_awesome_oscillator` | n/a | 8.48µs | 8.58µs | 4 | n/a |
| `finance_query::ind_balance_of_power` | n/a | 1.88µs | 1.96µs | 2 | n/a |
| `finance_query::ind_bull_bear_power` | n/a | 6.93µs | 7.00µs | 3 | n/a |
| `finance_query::ind_cci` | n/a | 17.04µs | 17.63µs | 2 | n/a |
| `finance_query::ind_chaikin_oscillator` | n/a | 15.86µs | 16.02µs | 4 | n/a |
| `finance_query::ind_choppiness_index` | n/a | 22.17µs | 22.77µs | 8 | n/a |
| `finance_query::ind_cmf` | n/a | 3.87µs | 4.18µs | 2 | n/a |
| `finance_query::ind_cmo` | n/a | 5.01µs | 5.09µs | 2 | n/a |
| `finance_query::ind_coppock_curve` | n/a | 7.66µs | 8.20µs | 3 | n/a |
| `finance_query::ind_dema` | n/a | 11.80µs | 11.84µs | 3 | n/a |
| `finance_query::ind_donchian_channels` | n/a | 11.94µs | 12.04µs | 9 | n/a |
| `finance_query::ind_elder_ray` | n/a | 6.90µs | 6.95µs | 3 | n/a |
| `finance_query::ind_fibonacci_pivot_points` | n/a | 2.38µs | 2.46µs | 1 | n/a |
| `finance_query::ind_fibonacci_retracement` | n/a | 11.38µs | 11.66µs | 9 | n/a |
| `finance_query::ind_heikin_ashi` | n/a | 14.67µs | 14.78µs | 9 | n/a |
| `finance_query::ind_hma` | n/a | 13.72µs | 13.80µs | 5 | n/a |
| `finance_query::ind_ichimoku` | n/a | 36.62µs | 40.10µs | 27 | n/a |
| `finance_query::ind_keltner_channels` | n/a | 17.10µs | 17.65µs | 5 | n/a |
| `finance_query::ind_last_value` | n/a | 2.8ns | 3.1ns | 0 | n/a |
| `finance_query::ind_macd` | n/a | 19.99µs | 20.16µs | 7 | n/a |
| `finance_query::ind_mcginley_dynamic` | n/a | 12.03µs | 12.13µs | 1 | n/a |
| `finance_query::ind_mfi` | n/a | 7.34µs | 7.39µs | 3 | n/a |
| `finance_query::ind_momentum` | n/a | 124.84µs | 134.32µs | 52 | n/a |
| `finance_query::ind_momentum_single` | n/a | 529.3ns | 533.7ns | 1 | n/a |
| `finance_query::ind_moving_averages` | n/a | 85.66µs | 86.10µs | 27 | n/a |
| `finance_query::ind_parabolic_sar` | n/a | 2.29µs | 2.33µs | 1 | n/a |
| `finance_query::ind_patterns` | n/a | 100.63µs | 106.65µs | 1 | n/a |
| `finance_query::ind_pivot_points` | n/a | 2.83µs | 2.91µs | 1 | n/a |
| `finance_query::ind_roc` | n/a | 1.64µs | 1.72µs | 1 | n/a |
| `finance_query::ind_sma` | n/a | 378.63µs | 386.00µs | 1 | n/a |
| `finance_query::ind_stochastic` | n/a | 16.51µs | 16.69µs | 11 | n/a |
| `finance_query::ind_stochastic_rsi` | n/a | 28.20µs | 29.38µs | 12 | n/a |
| `finance_query::ind_supertrend` | n/a | 13.30µs | 13.59µs | 4 | n/a |
| `finance_query::ind_tema` | n/a | 17.51µs | 17.61µs | 4 | n/a |
| `finance_query::ind_trend` | n/a | 94.65µs | 101.06µs | 48 | n/a |
| `finance_query::ind_true_range` | n/a | 1.24µs | 1.24µs | 1 | n/a |
| `finance_query::ind_volatility` | n/a | 70.62µs | 71.35µs | 28 | n/a |
| `finance_query::ind_volume` | n/a | 40.64µs | 42.18µs | 14 | n/a |
| `finance_query::ind_vwap` | n/a | 3.86µs | 3.94µs | 1 | n/a |
| `finance_query::ind_vwma` | n/a | 3.10µs | 3.10µs | 1 | n/a |
| `finance_query::ind_williams_r` | n/a | 10.94µs | 11.13µs | 7 | n/a |
| `finance_query::ind_wma` | n/a | 4.62µs | 4.65µs | 7 | n/a |
| `finance_query::ind_zigzag` | n/a | 1.89µs | 1.99µs | 4 | n/a |
| `finance_query::ref_bench_accumulation_distribution` | n/a | 49.62µs | 50.77µs | 23 | n/a |
| `finance_query::ref_bench_adx` | n/a | 533.58µs | 559.05µs | 4930 | n/a |
| `finance_query::ref_bench_alma` | n/a | 583.27µs | 591.06µs | 5019 | n/a |
| `finance_query::ref_bench_aroon` | n/a | 534.68µs | 562.97µs | 4950 | n/a |
| `finance_query::ref_bench_atr` | n/a | 538.21µs | 569.78µs | 4996 | n/a |
| `finance_query::ref_bench_awesome_oscillator` | n/a | 327.92µs | 347.75µs | 2636 | n/a |
| `finance_query::ref_bench_balance_of_power` | n/a | 45.90µs | 46.03µs | 25 | n/a |
| `finance_query::ref_bench_bear_power` | n/a | 140.75µs | 147.80µs | 806 | n/a |
| `finance_query::ref_bench_bollinger` | n/a | 594.40µs | 605.34µs | 4968 | n/a |
| `finance_query::ref_bench_bull_power` | n/a | 512.56µs | 519.25µs | 4238 | n/a |
| `finance_query::ref_bench_candle_body` | n/a | 20.53µs | 22.15µs | 6 | n/a |
| `finance_query::ref_bench_candle_range` | n/a | 505.76µs | 561.93µs | 5043 | n/a |
| `finance_query::ref_bench_cci` | n/a | 310.74µs | 328.64µs | 2605 | n/a |
| `finance_query::ref_bench_chaikin_oscillator` | n/a | 64.93µs | 66.41µs | 26 | n/a |
| `finance_query::ref_bench_choppiness_index` | n/a | 558.61µs | 567.75µs | 5002 | n/a |
| `finance_query::ref_bench_close` | n/a | 498.34µs | 518.45µs | 5043 | n/a |
| `finance_query::ref_bench_cmf` | n/a | 49.11µs | 49.40µs | 25 | n/a |
| `finance_query::ref_bench_cmo` | n/a | 301.50µs | 307.63µs | 2598 | n/a |
| `finance_query::ref_bench_coppock_curve` | n/a | 324.31µs | 363.73µs | 2559 | n/a |
| `finance_query::ref_bench_dema` | n/a | 527.54µs | 537.16µs | 4875 | n/a |
| `finance_query::ref_bench_donchian` | n/a | 589.30µs | 636.70µs | 4976 | n/a |
| `finance_query::ref_bench_elder_bear_power` | n/a | 141.05µs | 143.52µs | 806 | n/a |
| `finance_query::ref_bench_elder_bull_power` | n/a | 520.10µs | 552.77µs | 4238 | n/a |
| `finance_query::ref_bench_ema` | n/a | 529.88µs | 540.25µs | 4963 | n/a |
| `finance_query::ref_bench_gap_pct` | n/a | 262.32µs | 276.57µs | 2489 | n/a |
| `finance_query::ref_bench_high` | n/a | 500.11µs | 514.49µs | 5043 | n/a |
| `finance_query::ref_bench_hma` | n/a | 535.28µs | 574.10µs | 4957 | n/a |
| `finance_query::ref_bench_htf` | n/a | 630.79µs | 641.10µs | 7039 | n/a |
| `finance_query::ref_bench_htf_region` | n/a | 622.74µs | 650.95µs | 7039 | n/a |
| `finance_query::ref_bench_ichimoku` | n/a | 650.50µs | 696.92µs | 4836 | n/a |
| `finance_query::ref_bench_ichimoku_custom` | n/a | 644.97µs | 688.86µs | 4836 | n/a |
| `finance_query::ref_bench_is_bearish` | n/a | 21.55µs | 21.74µs | 6 | n/a |
| `finance_query::ref_bench_is_bullish` | n/a | 21.89µs | 22.22µs | 6 | n/a |
| `finance_query::ref_bench_keltner` | n/a | 604.40µs | 618.09µs | 4972 | n/a |
| `finance_query::ref_bench_low` | n/a | 501.18µs | 534.39µs | 5043 | n/a |
| `finance_query::ref_bench_macd` | n/a | 334.25µs | 340.79µs | 2541 | n/a |
| `finance_query::ref_bench_mcginley` | n/a | 537.23µs | 635.78µs | 4963 | n/a |
| `finance_query::ref_bench_median_price` | n/a | 505.89µs | 549.83µs | 5043 | n/a |
| `finance_query::ref_bench_mfi` | n/a | 541.63µs | 609.02µs | 4998 | n/a |
| `finance_query::ref_bench_momentum` | n/a | 293.01µs | 299.08µs | 2552 | n/a |
| `finance_query::ref_bench_obv` | n/a | 58.43µs | 60.52µs | 30 | n/a |
| `finance_query::ref_bench_open` | n/a | 512.01µs | 520.52µs | 5043 | n/a |
| `finance_query::ref_bench_parabolic_sar` | n/a | 583.72µs | 595.67µs | 5056 | n/a |
| `finance_query::ref_bench_price` | n/a | 496.89µs | 535.14µs | 5043 | n/a |
| `finance_query::ref_bench_price_change_pct` | n/a | 285.83µs | 298.17µs | 2489 | n/a |
| `finance_query::ref_bench_relative_volume` | n/a | 546.14µs | 584.77µs | 4949 | n/a |
| `finance_query::ref_bench_roc` | n/a | 291.88µs | 304.05µs | 2587 | n/a |
| `finance_query::ref_bench_rsi` | n/a | 533.58µs | 846.55µs | 4994 | n/a |
| `finance_query::ref_bench_sma` | n/a | 524.28µs | 554.18µs | 4963 | n/a |
| `finance_query::ref_bench_stochastic` | n/a | 614.04µs | 974.77µs | 4987 | n/a |
| `finance_query::ref_bench_stochastic_rsi` | n/a | 588.41µs | 629.77µs | 4831 | n/a |
| `finance_query::ref_bench_supertrend` | n/a | 596.93µs | 630.31µs | 5021 | n/a |
| `finance_query::ref_bench_tema` | n/a | 533.29µs | 559.89µs | 4781 | n/a |
| `finance_query::ref_bench_true_range` | n/a | 544.72µs | 553.14µs | 5059 | n/a |
| `finance_query::ref_bench_typical_price` | n/a | 556.77µs | 627.73µs | 5043 | n/a |
| `finance_query::ref_bench_volume` | n/a | 518.52µs | 593.86µs | 5043 | n/a |
| `finance_query::ref_bench_vwap` | n/a | 546.65µs | 565.48µs | 5060 | n/a |
| `finance_query::ref_bench_vwma` | n/a | 534.57µs | 556.04µs | 4964 | n/a |
| `finance_query::ref_bench_williams_r` | n/a | 59.58µs | 61.44µs | 29 | n/a |
| `finance_query::ref_bench_wma` | n/a | 532.52µs | 565.00µs | 4969 | n/a |
| `finance_query::risk_beta` | n/a | 61.21µs | 61.88µs | 0 | n/a |
| `finance_query::risk_calmar` | n/a | 16.3ns | 17.5ns | 0 | n/a |
| `finance_query::risk_historical_cvar` | n/a | 337.17µs | 344.11µs | 2 | n/a |
| `finance_query::risk_historical_var` | n/a | 2.60ms | 2.64ms | 2 | n/a |
| `finance_query::risk_information_ratio` | n/a | 36.30µs | 36.89µs | 1 | n/a |
| `finance_query::risk_kelly_criterion` | n/a | 3.74µs | 3.94µs | 16 | n/a |
| `finance_query::risk_max_drawdown` | n/a | 8.04µs | 8.41µs | 1 | n/a |
| `finance_query::risk_omega_ratio` | n/a | 30.62µs | 31.98µs | 0 | n/a |
| `finance_query::risk_parametric_cvar` | n/a | 30.63µs | 30.75µs | 0 | n/a |
| `finance_query::risk_parametric_var` | n/a | 30.63µs | 31.88µs | 0 | n/a |
| `finance_query::risk_sharpe` | n/a | 30.62µs | 30.88µs | 0 | n/a |
| `finance_query::risk_sortino` | n/a | 30.61µs | 30.88µs | 0 | n/a |
| `finance_query::risk_tracking_error` | n/a | 36.00µs | 38.28µs | 1 | n/a |
| `finance_query::risk_ulcer_index` | n/a | 175.40µs | 178.64µs | 2 | n/a |
| `finance_query::risk_win_loss_stats` | n/a | 157.69µs | 166.28µs | 25 | n/a |
| `finance_query::rss_parse` | n/a | 6.00µs | 8.16µs | 48 | n/a |
| `finance_query::score_news` | n/a | 87.21µs | 90.58µs | 976 | n/a |
| `finance_query::score_transcript` | n/a | 4.80ms | 4.89ms | 42100 | n/a |
| `finance_query::ser_currencies` | n/a | 21.58µs | 22.18µs | 8 | n/a |
| `finance_query::stream_deserialize` | n/a | 1.21µs | 1.66µs | 4 | n/a |
| `finance_query::stream_serialize` | n/a | 1.07µs | 1.10µs | 4 | n/a |
| `finance_query::ticker_chart_then_cached` | n/a | 1.30µs | 1.34µs | 20 | n/a |
| `finance_query::ticker_quote_then_cached` | n/a | 12.20µs | 12.79µs | 4 | n/a |
| `finance_query::tickers_batch_quote_then_cached` | n/a | 9.65µs | 11.84µs | 16 | n/a |
| `finance_query::translate_dictionary` | n/a | 1.91µs | 1.99µs | 49 | n/a |
| `finance_query::translation_set_backend` | n/a | 21.4ns | 23.6ns | 1 | n/a |
| `finance_query::translation_translate` | n/a | 3.61µs | 3.97µs | 79 | n/a |
| `finance_query::translation_translate_with` | n/a | 3.36µs | 3.45µs | 77 | n/a |
