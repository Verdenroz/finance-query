...
|---|---:|---:|---:|---:|---:|
| `finance_query::bt_base_to_htf_index` | n/a | 37.44µs | 37.94µs | 1 | n/a |
| `finance_query::bt_bayesian_search` | n/a | 2.80ms | 2.89ms | 2382 | n/a |
| `finance_query::bt_grid_search` | n/a | 677.88µs | 717.01µs | 3012 | n/a |
| `finance_query::bt_monte_carlo` | n/a | 168.74µs | 212.53µs | 6 | n/a |
| `finance_query::bt_resample` | n/a | 120.14µs | 124.64µs | 11 | n/a |
| `finance_query::bt_sma_crossover` | n/a | 937.62µs | 957.94µs | 2373 | n/a |
| `finance_query::bt_strategy_builder` | n/a | 147.56µs | 174.15µs | 330 | n/a |
| `finance_query::capability_name` | n/a | 2.3ns | 2.8ns | 0 | n/a |
| `finance_query::cond_bench_always_false` | n/a | 16.31µs | 17.49µs | 6 | n/a |
| `finance_query::cond_bench_always_true` | n/a | 459.55µs | 461.68µs | 4045 | n/a |
| `finance_query::cond_bench_has_position` | n/a | 459.82µs | 461.39µs | 4045 | n/a |
| `finance_query::cond_bench_held_for_bars` | n/a | 158.08µs | 164.70µs | 1041 | n/a |
| `finance_query::cond_bench_in_loss` | n/a | 462.17µs | 467.11µs | 4045 | n/a |
| `finance_query::cond_bench_in_profit` | n/a | 49.19µs | 50.80µs | 142 | n/a |
| `finance_query::cond_bench_is_long` | n/a | 461.04µs | 471.60µs | 4045 | n/a |
| `finance_query::cond_bench_is_short` | n/a | 33.87µs | 33.99µs | 13 | n/a |
| `finance_query::cond_bench_no_position` | n/a | 33.95µs | 38.36µs | 13 | n/a |
| `finance_query::cond_bench_stop_loss` | n/a | 40.74µs | 41.07µs | 24 | n/a |
| `finance_query::cond_bench_take_profit` | n/a | 39.41µs | 39.61µs | 13 | n/a |
| `finance_query::cond_bench_trailing_stop` | n/a | 49.81µs | 51.43µs | 92 | n/a |
| `finance_query::cond_bench_trailing_take_profit` | n/a | 50.52µs | 50.99µs | 72 | n/a |
| `finance_query::de_chart` | n/a | 8.21µs | 8.57µs | 13 | n/a |
| `finance_query::de_crypto_coins` | n/a | 30.71µs | 32.11µs | 205 | n/a |
| `finance_query::de_currencies` | n/a | 57.33µs | 57.77µs | 647 | n/a |
| `finance_query::de_edgar_facts` | n/a | 1.31ms | 1.41ms | 11899 | n/a |
| `finance_query::de_edgar_submissions` | n/a | 480.33µs | 492.66µs | 6784 | n/a |
| `finance_query::de_fear_and_greed` | n/a | 97.5ns | 98.9ns | 0 | n/a |
| `finance_query::de_fear_and_greed_crypto_history` | n/a | 1.25µs | 1.26µs | 3 | n/a |
| `finance_query::de_financials` | n/a | 21.85µs | 22.73µs | 206 | n/a |
| `finance_query::de_fred_series` | n/a | 99.85µs | 100.65µs | 873 | n/a |
| `finance_query::de_hours` | n/a | 755.8ns | 760.4ns | 10 | n/a |
| `finance_query::de_market_summary` | n/a | 27.33µs | 29.60µs | 228 | n/a |
| `finance_query::de_news` | n/a | 3.71µs | 3.78µs | 53 | n/a |
| `finance_query::de_options` | n/a | 1.06µs | 1.16µs | 6 | n/a |
| `finance_query::de_quote` | n/a | 987.10µs | 1.06ms | 8235 | n/a |
| `finance_query::de_screener` | n/a | 416.34µs | 422.83µs | 4498 | n/a |
| `finance_query::de_search` | n/a | 4.91µs | 4.94µs | 55 | n/a |
| `finance_query::de_treasury_yields` | n/a | 62.78µs | 63.09µs | 119 | n/a |
| `finance_query::de_trending` | n/a | 1.54µs | 1.59µs | 24 | n/a |
| `finance_query::dispatch_select` | n/a | 4.6ns | 4.8ns | 0 | n/a |
| `finance_query::ind_accumulation_distribution` | n/a | 2.99µs | 3.01µs | 1 | n/a |
| `finance_query::ind_alma` | n/a | 4.96µs | 5.11µs | 2 | n/a |
| `finance_query::ind_aroon` | n/a | 11.54µs | 11.70µs | 9 | n/a |
| `finance_query::ind_atr` | n/a | 8.57µs | 8.68µs | 2 | n/a |
| `finance_query::ind_awesome_oscillator` | n/a | 6.26µs | 6.27µs | 4 | n/a |
| `finance_query::ind_balance_of_power` | n/a | 2.08µs | 2.12µs | 2 | n/a |
| `finance_query::ind_bull_bear_power` | n/a | 6.50µs | 6.55µs | 3 | n/a |
| `finance_query::ind_cci` | n/a | 16.41µs | 16.81µs | 2 | n/a |
| `finance_query::ind_chaikin_oscillator` | n/a | 13.22µs | 13.31µs | 4 | n/a |
| `finance_query::ind_choppiness_index` | n/a | 20.35µs | 20.87µs | 8 | n/a |
| `finance_query::ind_cmf` | n/a | 5.09µs | 5.16µs | 2 | n/a |
| `finance_query::ind_cmo` | n/a | 5.36µs | 5.51µs | 2 | n/a |
| `finance_query::ind_coppock_curve` | n/a | 6.08µs | 6.21µs | 3 | n/a |
| `finance_query::ind_dema` | n/a | 10.31µs | 10.45µs | 3 | n/a |
| `finance_query::ind_donchian_channels` | n/a | 11.05µs | 11.43µs | 9 | n/a |
| `finance_query::ind_elder_ray` | n/a | 6.50µs | 6.52µs | 3 | n/a |
| `finance_query::ind_fibonacci_pivot_points` | n/a | 3.26µs | 3.31µs | 1 | n/a |
| `finance_query::ind_fibonacci_retracement` | n/a | 11.39µs | 11.80µs | 9 | n/a |
| `finance_query::ind_heikin_ashi` | n/a | 12.34µs | 13.50µs | 9 | n/a |
| `finance_query::ind_hma` | n/a | 10.20µs | 10.35µs | 5 | n/a |
| `finance_query::ind_ichimoku` | n/a | 33.79µs | 34.57µs | 27 | n/a |
| `finance_query::ind_keltner_channels` | n/a | 15.55µs | 15.73µs | 5 | n/a |
| `finance_query::ind_last_value` | n/a | 2.2ns | 2.4ns | 0 | n/a |
| `finance_query::ind_macd` | n/a | 18.02µs | 18.17µs | 7 | n/a |
| `finance_query::ind_mcginley_dynamic` | n/a | 12.65µs | 12.67µs | 1 | n/a |
| `finance_query::ind_mfi` | n/a | 6.71µs | 6.93µs | 3 | n/a |
| `finance_query::ind_momentum` | n/a | 119.17µs | 123.83µs | 52 | n/a |
| `finance_query::ind_momentum_single` | n/a | 535.0ns | 539.9ns | 1 | n/a |
| `finance_query::ind_moving_averages` | n/a | 74.10µs | 80.23µs | 27 | n/a |
| `finance_query::ind_parabolic_sar` | n/a | 2.30µs | 2.41µs | 1 | n/a |
| `finance_query::ind_patterns` | n/a | 93.20µs | 96.02µs | 1 | n/a |
| `finance_query::ind_pivot_points` | n/a | 3.22µs | 3.28µs | 1 | n/a |
| `finance_query::ind_roc` | n/a | 1.64µs | 1.64µs | 1 | n/a |
| `finance_query::ind_sma` | n/a | 262.26µs | 313.43µs | 1 | n/a |
| `finance_query::ind_stochastic` | n/a | 14.77µs | 15.46µs | 11 | n/a |
| `finance_query::ind_stochastic_rsi` | n/a | 23.05µs | 23.31µs | 12 | n/a |
| `finance_query::ind_supertrend` | n/a | 12.36µs | 12.46µs | 4 | n/a |
| `finance_query::ind_tema` | n/a | 15.06µs | 15.17µs | 4 | n/a |
| `finance_query::ind_trend` | n/a | 86.40µs | 90.64µs | 48 | n/a |
| `finance_query::ind_true_range` | n/a | 1.43µs | 1.54µs | 1 | n/a |
| `finance_query::ind_volatility` | n/a | 64.27µs | 67.02µs | 28 | n/a |
| `finance_query::ind_volume` | n/a | 35.70µs | 36.09µs | 14 | n/a |
| `finance_query::ind_vwap` | n/a | 2.77µs | 2.83µs | 1 | n/a |
| `finance_query::ind_vwma` | n/a | 2.91µs | 2.96µs | 1 | n/a |
| `finance_query::ind_williams_r` | n/a | 10.53µs | 10.75µs | 7 | n/a |
| `finance_query::ind_wma` | n/a | 3.27µs | 3.33µs | 7 | n/a |
| `finance_query::ind_zigzag` | n/a | 1.54µs | 1.57µs | 4 | n/a |
| `finance_query::ref_bench_accumulation_distribution` | n/a | 44.06µs | 45.18µs | 23 | n/a |
| `finance_query::ref_bench_adx` | n/a | 549.70µs | 617.03µs | 4930 | n/a |
| `finance_query::ref_bench_alma` | n/a | 592.37µs | 619.15µs | 5019 | n/a |
| `finance_query::ref_bench_aroon` | n/a | 554.85µs | 564.31µs | 4950 | n/a |
| `finance_query::ref_bench_atr` | n/a | 555.61µs | 569.86µs | 4996 | n/a |
| `finance_query::ref_bench_awesome_oscillator` | n/a | 328.12µs | 338.94µs | 2636 | n/a |
| `finance_query::ref_bench_balance_of_power` | n/a | 43.91µs | 44.05µs | 25 | n/a |
| `finance_query::ref_bench_bear_power` | n/a | 140.42µs | 144.00µs | 806 | n/a |
| `finance_query::ref_bench_bollinger` | n/a | 590.34µs | 617.65µs | 4968 | n/a |
| `finance_query::ref_bench_bull_power` | n/a | 515.81µs | 522.71µs | 4238 | n/a |
| `finance_query::ref_bench_candle_body` | n/a | 17.10µs | 17.62µs | 6 | n/a |
| `finance_query::ref_bench_candle_range` | n/a | 528.30µs | 536.56µs | 5043 | n/a |
| `finance_query::ref_bench_cci` | n/a | 313.01µs | 323.96µs | 2605 | n/a |
| `finance_query::ref_bench_chaikin_oscillator` | n/a | 58.41µs | 59.21µs | 26 | n/a |
| `finance_query::ref_bench_choppiness_index` | n/a | 574.50µs | 613.03µs | 5002 | n/a |
| `finance_query::ref_bench_close` | n/a | 528.40µs | 535.86µs | 5043 | n/a |
| `finance_query::ref_bench_cmf` | n/a | 46.83µs | 48.24µs | 25 | n/a |
| `finance_query::ref_bench_cmo` | n/a | 301.70µs | 330.61µs | 2598 | n/a |
| `finance_query::ref_bench_coppock_curve` | n/a | 317.93µs | 331.04µs | 2559 | n/a |
| `finance_query::ref_bench_dema` | n/a | 546.87µs | 553.51µs | 4875 | n/a |
| `finance_query::ref_bench_donchian` | n/a | 599.46µs | 603.88µs | 4976 | n/a |
| `finance_query::ref_bench_elder_bear_power` | n/a | 139.71µs | 143.92µs | 806 | n/a |
| `finance_query::ref_bench_elder_bull_power` | n/a | 516.70µs | 521.22µs | 4238 | n/a |
| `finance_query::ref_bench_ema` | n/a | 544.81µs | 546.67µs | 4963 | n/a |
| `finance_query::ref_bench_gap_pct` | n/a | 268.30µs | 291.37µs | 2489 | n/a |
| `finance_query::ref_bench_high` | n/a | 528.01µs | 533.79µs | 5043 | n/a |
| `finance_query::ref_bench_hma` | n/a | 552.08µs | 562.57µs | 4957 | n/a |
| `finance_query::ref_bench_htf` | n/a | 649.19µs | 659.52µs | 7039 | n/a |
| `finance_query::ref_bench_htf_region` | n/a | 647.06µs | 648.91µs | 7039 | n/a |
| `finance_query::ref_bench_ichimoku` | n/a | 624.41µs | 632.74µs | 4836 | n/a |
| `finance_query::ref_bench_ichimoku_custom` | n/a | 623.82µs | 640.53µs | 4836 | n/a |
| `finance_query::ref_bench_is_bearish` | n/a | 16.92µs | 17.00µs | 6 | n/a |
| `finance_query::ref_bench_is_bullish` | n/a | 16.92µs | 17.47µs | 6 | n/a |
| `finance_query::ref_bench_keltner` | n/a | 605.50µs | 657.78µs | 4972 | n/a |
| `finance_query::ref_bench_low` | n/a | 527.03µs | 545.55µs | 5043 | n/a |
| `finance_query::ref_bench_macd` | n/a | 329.44µs | 339.40µs | 2541 | n/a |
| `finance_query::ref_bench_mcginley` | n/a | 556.90µs | 566.78µs | 4963 | n/a |
| `finance_query::ref_bench_median_price` | n/a | 526.09µs | 546.09µs | 5043 | n/a |
| `finance_query::ref_bench_mfi` | n/a | 553.92µs | 572.49µs | 4998 | n/a |
| `finance_query::ref_bench_momentum` | n/a | 296.21µs | 296.87µs | 2552 | n/a |
| `finance_query::ref_bench_obv` | n/a | 55.28µs | 56.94µs | 30 | n/a |
| `finance_query::ref_bench_open` | n/a | 529.11µs | 539.87µs | 5043 | n/a |
| `finance_query::ref_bench_parabolic_sar` | n/a | 596.80µs | 637.88µs | 5056 | n/a |
| `finance_query::ref_bench_price` | n/a | 527.65µs | 545.90µs | 5043 | n/a |
| `finance_query::ref_bench_price_change_pct` | n/a | 287.46µs | 300.47µs | 2489 | n/a |
| `finance_query::ref_bench_relative_volume` | n/a | 571.30µs | 593.23µs | 4949 | n/a |
| `finance_query::ref_bench_roc` | n/a | 296.39µs | 303.82µs | 2587 | n/a |
| `finance_query::ref_bench_rsi` | n/a | 551.77µs | 553.74µs | 4994 | n/a |
| `finance_query::ref_bench_sma` | n/a | 540.89µs | 550.94µs | 4963 | n/a |
| `finance_query::ref_bench_stochastic` | n/a | 603.72µs | 631.60µs | 4987 | n/a |
| `finance_query::ref_bench_stochastic_rsi` | n/a | 595.37µs | 637.65µs | 4831 | n/a |
| `finance_query::ref_bench_supertrend` | n/a | 602.56µs | 627.98µs | 5021 | n/a |
| `finance_query::ref_bench_tema` | n/a | 543.44µs | 558.53µs | 4781 | n/a |
| `finance_query::ref_bench_true_range` | n/a | 553.46µs | 556.00µs | 5059 | n/a |
| `finance_query::ref_bench_typical_price` | n/a | 568.72µs | 592.76µs | 5043 | n/a |
| `finance_query::ref_bench_volume` | n/a | 528.25µs | 538.10µs | 5043 | n/a |
| `finance_query::ref_bench_vwap` | n/a | 554.98µs | 569.94µs | 5060 | n/a |
| `finance_query::ref_bench_vwma` | n/a | 549.18µs | 570.96µs | 4964 | n/a |
| `finance_query::ref_bench_williams_r` | n/a | 55.81µs | 56.76µs | 29 | n/a |
| `finance_query::ref_bench_wma` | n/a | 544.37µs | 564.35µs | 4969 | n/a |
| `finance_query::risk_beta` | n/a | 75.32µs | 75.70µs | 0 | n/a |
| `finance_query::risk_calmar` | n/a | 16.7ns | 17.1ns | 0 | n/a |
| `finance_query::risk_historical_cvar` | n/a | 333.53µs | 348.64µs | 2 | n/a |
| `finance_query::risk_historical_var` | n/a | 2.50ms | 2.54ms | 2 | n/a |
| `finance_query::risk_information_ratio` | n/a | 42.80µs | 42.96µs | 1 | n/a |
| `finance_query::risk_kelly_criterion` | n/a | 3.79µs | 3.80µs | 16 | n/a |
| `finance_query::risk_max_drawdown` | n/a | 5.65µs | 5.68µs | 1 | n/a |
| `finance_query::risk_omega_ratio` | n/a | 37.63µs | 37.71µs | 0 | n/a |
| `finance_query::risk_parametric_cvar` | n/a | 37.68µs | 37.96µs | 0 | n/a |
| `finance_query::risk_parametric_var` | n/a | 37.70µs | 39.35µs | 0 | n/a |
| `finance_query::risk_sharpe` | n/a | 37.73µs | 38.40µs | 0 | n/a |
| `finance_query::risk_sortino` | n/a | 37.71µs | 37.84µs | 0 | n/a |
| `finance_query::risk_tracking_error` | n/a | 42.86µs | 43.12µs | 1 | n/a |
| `finance_query::risk_ulcer_index` | n/a | 129.86µs | 132.50µs | 2 | n/a |
| `finance_query::risk_win_loss_stats` | n/a | 142.96µs | 148.29µs | 25 | n/a |
| `finance_query::rss_parse` | n/a | 5.55µs | 5.68µs | 48 | n/a |
| `finance_query::score_news` | n/a | 75.35µs | 75.81µs | 976 | n/a |
| `finance_query::score_transcript` | n/a | 4.36ms | 4.45ms | 42100 | n/a |
| `finance_query::ser_currencies` | n/a | 15.84µs | 16.24µs | 8 | n/a |
| `finance_query::stream_deserialize` | n/a | 1.12µs | 1.15µs | 4 | n/a |
| `finance_query::stream_serialize` | n/a | 1.03µs | 1.05µs | 4 | n/a |
| `finance_query::ticker_chart_then_cached` | n/a | 1.58µs | 1.62µs | 20 | n/a |
| `finance_query::ticker_quote_polls` | n/a | 7.49µs | 7.95µs | 3 | 1 |
| `finance_query::ticker_quote_then_cached` | n/a | 11.31µs | 11.47µs | 4 | n/a |
| `finance_query::tickers_batch_quote_then_cached` | n/a | 8.88µs | 9.18µs | 16 | n/a |
| `finance_query::translate_dictionary` | n/a | 2.63µs | 2.68µs | 49 | n/a |
| `finance_query::translation_set_backend` | n/a | 49.0ns | 51.5ns | 1 | n/a |
| `finance_query::translation_translate` | n/a | 4.36µs | 4.42µs | 79 | n/a |
| `finance_query::translation_translate_with` | n/a | 4.21µs | 4.24µs | 77 | n/a |
