...
|---|---:|---:|---:|---:|---:|
| `finance_query::bt_base_to_htf_index` | n/a | 20.30µs | 20.88µs | 1 | n/a |
| `finance_query::bt_bayesian_search` | n/a | 1.81ms | 1.83ms | 2382 | n/a |
| `finance_query::bt_grid_search` | n/a | 485.79µs | 601.66µs | 3012 | n/a |
| `finance_query::bt_monte_carlo` | n/a | 126.91µs | 136.67µs | 6 | n/a |
| `finance_query::bt_resample` | n/a | 78.48µs | 79.73µs | 11 | n/a |
| `finance_query::bt_sma_crossover` | n/a | 653.28µs | 664.36µs | 2373 | n/a |
| `finance_query::bt_strategy_builder` | n/a | 117.69µs | 150.93µs | 330 | n/a |
| `finance_query::capability_name` | n/a | 1.4ns | 1.6ns | 0 | n/a |
| `finance_query::cond_bench_always_false` | n/a | 11.67µs | 11.71µs | 6 | n/a |
| `finance_query::cond_bench_always_true` | n/a | 342.64µs | 346.03µs | 4045 | n/a |
| `finance_query::cond_bench_has_position` | n/a | 342.08µs | 351.55µs | 4045 | n/a |
| `finance_query::cond_bench_held_for_bars` | n/a | 111.84µs | 113.46µs | 1041 | n/a |
| `finance_query::cond_bench_in_loss` | n/a | 341.05µs | 344.89µs | 4045 | n/a |
| `finance_query::cond_bench_in_profit` | n/a | 32.72µs | 32.99µs | 142 | n/a |
| `finance_query::cond_bench_is_long` | n/a | 340.83µs | 347.27µs | 4045 | n/a |
| `finance_query::cond_bench_is_short` | n/a | 21.58µs | 21.78µs | 13 | n/a |
| `finance_query::cond_bench_no_position` | n/a | 21.68µs | 21.83µs | 13 | n/a |
| `finance_query::cond_bench_stop_loss` | n/a | 24.78µs | 25.00µs | 24 | n/a |
| `finance_query::cond_bench_take_profit` | n/a | 23.41µs | 23.73µs | 13 | n/a |
| `finance_query::cond_bench_trailing_stop` | n/a | 32.56µs | 32.87µs | 92 | n/a |
| `finance_query::cond_bench_trailing_take_profit` | n/a | 31.95µs | 33.56µs | 72 | n/a |
| `finance_query::de_chart` | n/a | 5.20µs | 5.41µs | 13 | n/a |
| `finance_query::de_crypto_coins` | n/a | 19.20µs | 19.96µs | 205 | n/a |
| `finance_query::de_currencies` | n/a | 41.27µs | 43.22µs | 647 | n/a |
| `finance_query::de_edgar_facts` | n/a | 925.58µs | 958.84µs | 11899 | n/a |
| `finance_query::de_edgar_submissions` | n/a | 351.36µs | 354.07µs | 6784 | n/a |
| `finance_query::de_fear_and_greed` | n/a | 60.3ns | 62.5ns | 0 | n/a |
| `finance_query::de_fear_and_greed_crypto_history` | n/a | 747.6ns | 761.5ns | 3 | n/a |
| `finance_query::de_financials` | n/a | 14.51µs | 14.64µs | 206 | n/a |
| `finance_query::de_fred_series` | n/a | 65.69µs | 68.94µs | 873 | n/a |
| `finance_query::de_hours` | n/a | 514.8ns | 533.9ns | 10 | n/a |
| `finance_query::de_market_summary` | n/a | 19.07µs | 19.32µs | 228 | n/a |
| `finance_query::de_news` | n/a | 2.39µs | 2.42µs | 53 | n/a |
| `finance_query::de_options` | n/a | 686.5ns | 704.6ns | 6 | n/a |
| `finance_query::de_quote` | n/a | 659.89µs | 672.99µs | 8235 | n/a |
| `finance_query::de_screener` | n/a | 280.55µs | 285.39µs | 4498 | n/a |
| `finance_query::de_search` | n/a | 3.50µs | 3.57µs | 55 | n/a |
| `finance_query::de_treasury_yields` | n/a | 39.28µs | 40.40µs | 119 | n/a |
| `finance_query::de_trending` | n/a | 1.02µs | 1.08µs | 24 | n/a |
| `finance_query::dispatch_select` | n/a | 2.6ns | 2.8ns | 0 | n/a |
| `finance_query::ind_accumulation_distribution` | n/a | 2.21µs | 2.24µs | 1 | n/a |
| `finance_query::ind_alma` | n/a | 3.11µs | 3.14µs | 2 | n/a |
| `finance_query::ind_aroon` | n/a | 7.87µs | 8.53µs | 9 | n/a |
| `finance_query::ind_atr` | n/a | 6.60µs | 6.63µs | 2 | n/a |
| `finance_query::ind_awesome_oscillator` | n/a | 4.47µs | 4.77µs | 4 | n/a |
| `finance_query::ind_balance_of_power` | n/a | 1.24µs | 1.25µs | 2 | n/a |
| `finance_query::ind_bull_bear_power` | n/a | 4.22µs | 4.26µs | 3 | n/a |
| `finance_query::ind_cci` | n/a | 9.05µs | 9.09µs | 2 | n/a |
| `finance_query::ind_chaikin_oscillator` | n/a | 9.13µs | 9.47µs | 4 | n/a |
| `finance_query::ind_choppiness_index` | n/a | 13.02µs | 13.79µs | 8 | n/a |
| `finance_query::ind_cmf` | n/a | 2.16µs | 2.17µs | 2 | n/a |
| `finance_query::ind_cmo` | n/a | 3.65µs | 3.69µs | 2 | n/a |
| `finance_query::ind_coppock_curve` | n/a | 4.47µs | 4.59µs | 3 | n/a |
| `finance_query::ind_dema` | n/a | 7.00µs | 7.04µs | 3 | n/a |
| `finance_query::ind_donchian_channels` | n/a | 8.23µs | 8.36µs | 9 | n/a |
| `finance_query::ind_elder_ray` | n/a | 4.22µs | 4.26µs | 3 | n/a |
| `finance_query::ind_fibonacci_pivot_points` | n/a | 2.16µs | 2.17µs | 1 | n/a |
| `finance_query::ind_fibonacci_retracement` | n/a | 8.45µs | 8.57µs | 9 | n/a |
| `finance_query::ind_heikin_ashi` | n/a | 8.70µs | 8.82µs | 9 | n/a |
| `finance_query::ind_hma` | n/a | 7.29µs | 7.44µs | 5 | n/a |
| `finance_query::ind_ichimoku` | n/a | 23.96µs | 25.34µs | 27 | n/a |
| `finance_query::ind_keltner_channels` | n/a | 11.21µs | 11.40µs | 5 | n/a |
| `finance_query::ind_last_value` | n/a | 1.7ns | 1.8ns | 0 | n/a |
| `finance_query::ind_macd` | n/a | 12.20µs | 12.22µs | 7 | n/a |
| `finance_query::ind_mcginley_dynamic` | n/a | 10.06µs | 10.08µs | 1 | n/a |
| `finance_query::ind_mfi` | n/a | 4.26µs | 4.30µs | 3 | n/a |
| `finance_query::ind_momentum` | n/a | 80.97µs | 87.96µs | 52 | n/a |
| `finance_query::ind_momentum_single` | n/a | 381.2ns | 391.0ns | 1 | n/a |
| `finance_query::ind_moving_averages` | n/a | 52.72µs | 55.37µs | 27 | n/a |
| `finance_query::ind_parabolic_sar` | n/a | 1.60µs | 1.63µs | 1 | n/a |
| `finance_query::ind_patterns` | n/a | 67.82µs | 69.51µs | 1 | n/a |
| `finance_query::ind_pivot_points` | n/a | 2.96µs | 3.54µs | 1 | n/a |
| `finance_query::ind_roc` | n/a | 1.31µs | 1.37µs | 1 | n/a |
| `finance_query::ind_sma` | n/a | 230.23µs | 243.71µs | 1 | n/a |
| `finance_query::ind_stochastic` | n/a | 12.38µs | 12.52µs | 11 | n/a |
| `finance_query::ind_stochastic_rsi` | n/a | 18.70µs | 19.05µs | 12 | n/a |
| `finance_query::ind_supertrend` | n/a | 10.36µs | 10.43µs | 4 | n/a |
| `finance_query::ind_tema` | n/a | 10.79µs | 11.55µs | 4 | n/a |
| `finance_query::ind_trend` | n/a | 71.86µs | 75.60µs | 48 | n/a |
| `finance_query::ind_true_range` | n/a | 1.04µs | 1.18µs | 1 | n/a |
| `finance_query::ind_volatility` | n/a | 51.01µs | 58.99µs | 28 | n/a |
| `finance_query::ind_volume` | n/a | 26.28µs | 26.52µs | 14 | n/a |
| `finance_query::ind_vwap` | n/a | 2.47µs | 2.66µs | 1 | n/a |
| `finance_query::ind_vwma` | n/a | 2.39µs | 2.57µs | 1 | n/a |
| `finance_query::ind_williams_r` | n/a | 9.58µs | 9.92µs | 7 | n/a |
| `finance_query::ind_wma` | n/a | 2.65µs | 2.67µs | 7 | n/a |
| `finance_query::ind_zigzag` | n/a | 1.39µs | 1.52µs | 4 | n/a |
| `finance_query::ref_bench_accumulation_distribution` | n/a | 27.24µs | 28.57µs | 23 | n/a |
| `finance_query::ref_bench_adx` | n/a | 400.03µs | 409.60µs | 4930 | n/a |
| `finance_query::ref_bench_alma` | n/a | 428.53µs | 442.46µs | 5019 | n/a |
| `finance_query::ref_bench_aroon` | n/a | 406.78µs | 414.80µs | 4950 | n/a |
| `finance_query::ref_bench_atr` | n/a | 407.05µs | 458.94µs | 4996 | n/a |
| `finance_query::ref_bench_awesome_oscillator` | n/a | 233.89µs | 246.36µs | 2636 | n/a |
| `finance_query::ref_bench_balance_of_power` | n/a | 27.22µs | 27.60µs | 25 | n/a |
| `finance_query::ref_bench_bear_power` | n/a | 103.22µs | 103.89µs | 806 | n/a |
| `finance_query::ref_bench_bollinger` | n/a | 450.21µs | 462.07µs | 4968 | n/a |
| `finance_query::ref_bench_bull_power` | n/a | 397.73µs | 441.43µs | 4238 | n/a |
| `finance_query::ref_bench_candle_body` | n/a | 13.00µs | 13.19µs | 6 | n/a |
| `finance_query::ref_bench_candle_range` | n/a | 414.16µs | 420.38µs | 5043 | n/a |
| `finance_query::ref_bench_cci` | n/a | 239.83µs | 242.49µs | 2605 | n/a |
| `finance_query::ref_bench_chaikin_oscillator` | n/a | 37.15µs | 37.60µs | 26 | n/a |
| `finance_query::ref_bench_choppiness_index` | n/a | 430.55µs | 442.75µs | 5002 | n/a |
| `finance_query::ref_bench_close` | n/a | 397.60µs | 411.11µs | 5043 | n/a |
| `finance_query::ref_bench_cmf` | n/a | 26.44µs | 27.23µs | 25 | n/a |
| `finance_query::ref_bench_cmo` | n/a | 227.47µs | 234.71µs | 2598 | n/a |
| `finance_query::ref_bench_coppock_curve` | n/a | 244.07µs | 248.81µs | 2559 | n/a |
| `finance_query::ref_bench_dema` | n/a | 416.51µs | 425.04µs | 4875 | n/a |
| `finance_query::ref_bench_donchian` | n/a | 436.93µs | 452.65µs | 4976 | n/a |
| `finance_query::ref_bench_elder_bear_power` | n/a | 98.60µs | 102.87µs | 806 | n/a |
| `finance_query::ref_bench_elder_bull_power` | n/a | 392.32µs | 402.58µs | 4238 | n/a |
| `finance_query::ref_bench_ema` | n/a | 419.70µs | 428.00µs | 4963 | n/a |
| `finance_query::ref_bench_gap_pct` | n/a | 214.18µs | 217.51µs | 2489 | n/a |
| `finance_query::ref_bench_high` | n/a | 414.46µs | 423.42µs | 5043 | n/a |
| `finance_query::ref_bench_hma` | n/a | 407.84µs | 427.62µs | 4957 | n/a |
| `finance_query::ref_bench_htf` | n/a | 467.15µs | 486.91µs | 7039 | n/a |
| `finance_query::ref_bench_htf_region` | n/a | 486.97µs | 496.03µs | 7039 | n/a |
| `finance_query::ref_bench_ichimoku` | n/a | 480.38µs | 494.62µs | 4836 | n/a |
| `finance_query::ref_bench_ichimoku_custom` | n/a | 477.33µs | 484.16µs | 4836 | n/a |
| `finance_query::ref_bench_is_bearish` | n/a | 12.24µs | 12.73µs | 6 | n/a |
| `finance_query::ref_bench_is_bullish` | n/a | 12.31µs | 12.93µs | 6 | n/a |
| `finance_query::ref_bench_keltner` | n/a | 460.27µs | 481.58µs | 4972 | n/a |
| `finance_query::ref_bench_low` | n/a | 443.54µs | 595.15µs | 5043 | n/a |
| `finance_query::ref_bench_macd` | n/a | 259.47µs | 269.19µs | 2541 | n/a |
| `finance_query::ref_bench_mcginley` | n/a | 427.63µs | 434.07µs | 4963 | n/a |
| `finance_query::ref_bench_median_price` | n/a | 394.85µs | 412.07µs | 5043 | n/a |
| `finance_query::ref_bench_mfi` | n/a | 383.52µs | 419.12µs | 4998 | n/a |
| `finance_query::ref_bench_momentum` | n/a | 206.35µs | 228.90µs | 2552 | n/a |
| `finance_query::ref_bench_obv` | n/a | 32.58µs | 33.16µs | 30 | n/a |
| `finance_query::ref_bench_open` | n/a | 379.12µs | 382.73µs | 5043 | n/a |
| `finance_query::ref_bench_parabolic_sar` | n/a | 410.57µs | 428.22µs | 5056 | n/a |
| `finance_query::ref_bench_price` | n/a | 378.10µs | 390.79µs | 5043 | n/a |
| `finance_query::ref_bench_price_change_pct` | n/a | 203.72µs | 207.95µs | 2489 | n/a |
| `finance_query::ref_bench_relative_volume` | n/a | 397.46µs | 409.64µs | 4949 | n/a |
| `finance_query::ref_bench_roc` | n/a | 208.03µs | 211.02µs | 2587 | n/a |
| `finance_query::ref_bench_rsi` | n/a | 380.77µs | 386.83µs | 4994 | n/a |
| `finance_query::ref_bench_sma` | n/a | 377.45µs | 386.13µs | 4963 | n/a |
| `finance_query::ref_bench_stochastic` | n/a | 419.27µs | 430.07µs | 4987 | n/a |
| `finance_query::ref_bench_stochastic_rsi` | n/a | 416.93µs | 429.85µs | 4831 | n/a |
| `finance_query::ref_bench_supertrend` | n/a | 414.81µs | 424.80µs | 5021 | n/a |
| `finance_query::ref_bench_tema` | n/a | 376.44µs | 398.32µs | 4781 | n/a |
| `finance_query::ref_bench_true_range` | n/a | 384.79µs | 396.37µs | 5059 | n/a |
| `finance_query::ref_bench_typical_price` | n/a | 400.20µs | 406.71µs | 5043 | n/a |
| `finance_query::ref_bench_volume` | n/a | 374.28µs | 379.51µs | 5043 | n/a |
| `finance_query::ref_bench_vwap` | n/a | 390.01µs | 405.69µs | 5060 | n/a |
| `finance_query::ref_bench_vwma` | n/a | 379.14µs | 383.99µs | 4964 | n/a |
| `finance_query::ref_bench_williams_r` | n/a | 32.33µs | 33.52µs | 29 | n/a |
| `finance_query::ref_bench_wma` | n/a | 377.44µs | 388.44µs | 4969 | n/a |
| `finance_query::risk_beta` | n/a | 32.49µs | 32.57µs | 0 | n/a |
| `finance_query::risk_calmar` | n/a | 10.7ns | 11.2ns | 0 | n/a |
| `finance_query::risk_historical_cvar` | n/a | 246.95µs | 256.78µs | 2 | n/a |
| `finance_query::risk_historical_var` | n/a | 1.83ms | 1.86ms | 2 | n/a |
| `finance_query::risk_information_ratio` | n/a | 18.71µs | 18.87µs | 1 | n/a |
| `finance_query::risk_kelly_criterion` | n/a | 2.70µs | 2.73µs | 16 | n/a |
| `finance_query::risk_max_drawdown` | n/a | 4.77µs | 4.80µs | 1 | n/a |
| `finance_query::risk_omega_ratio` | n/a | 15.71µs | 15.87µs | 0 | n/a |
| `finance_query::risk_parametric_cvar` | n/a | 15.73µs | 15.83µs | 0 | n/a |
| `finance_query::risk_parametric_var` | n/a | 15.73µs | 15.79µs | 0 | n/a |
| `finance_query::risk_sharpe` | n/a | 15.74µs | 15.80µs | 0 | n/a |
| `finance_query::risk_sortino` | n/a | 15.72µs | 15.80µs | 0 | n/a |
| `finance_query::risk_tracking_error` | n/a | 18.72µs | 18.83µs | 1 | n/a |
| `finance_query::risk_ulcer_index` | n/a | 103.72µs | 104.00µs | 2 | n/a |
| `finance_query::risk_win_loss_stats` | n/a | 116.08µs | 118.12µs | 25 | n/a |
| `finance_query::rss_parse` | n/a | 3.83µs | 4.26µs | 48 | n/a |
| `finance_query::score_news` | n/a | 52.20µs | 53.05µs | 976 | n/a |
| `finance_query::score_transcript` | n/a | 3.07ms | 3.40ms | 42100 | n/a |
| `finance_query::ser_currencies` | n/a | 9.79µs | 10.20µs | 8 | n/a |
| `finance_query::stream_deserialize` | n/a | 739.0ns | 771.4ns | 4 | n/a |
| `finance_query::stream_serialize` | n/a | 645.5ns | 705.5ns | 4 | n/a |
| `finance_query::ticker_chart_then_cached` | n/a | 1.18µs | 1.20µs | 20 | n/a |
| `finance_query::ticker_quote_then_cached` | n/a | 9.06µs | 9.10µs | 4 | n/a |
| `finance_query::tickers_batch_quote_then_cached` | n/a | 6.50µs | 6.62µs | 16 | n/a |
| `finance_query::translate_dictionary` | n/a | 1.90µs | 1.93µs | 49 | n/a |
| `finance_query::translation_set_backend` | n/a | 35.4ns | 36.0ns | 1 | n/a |
| `finance_query::translation_translate` | n/a | 3.11µs | 3.15µs | 79 | n/a |
| `finance_query::translation_translate_with` | n/a | 2.95µs | 3.35µs | 77 | n/a |
