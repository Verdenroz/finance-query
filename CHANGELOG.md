...
|---|---:|---:|---:|---:|---:|
| `finance_query::bt_base_to_htf_index` | n/a | 27.93µs | 32.05µs | 1 | n/a |
| `finance_query::bt_bayesian_search` | n/a | 2.96ms | 3.03ms | 2382 | n/a |
| `finance_query::bt_grid_search` | n/a | 648.59µs | 689.66µs | 3012 | n/a |
| `finance_query::bt_monte_carlo` | n/a | 181.39µs | 189.03µs | 6 | n/a |
| `finance_query::bt_resample` | n/a | 117.13µs | 119.38µs | 11 | n/a |
| `finance_query::bt_sma_crossover` | n/a | 972.53µs | 996.46µs | 2373 | n/a |
| `finance_query::bt_strategy_builder` | n/a | 164.31µs | 173.64µs | 330 | n/a |
| `finance_query::capability_name` | n/a | 3.5ns | 4.0ns | 0 | n/a |
| `finance_query::cond_bench_always_false` | n/a | 23.83µs | 24.47µs | 6 | n/a |
| `finance_query::cond_bench_always_true` | n/a | 422.86µs | 453.42µs | 4045 | n/a |
| `finance_query::cond_bench_has_position` | n/a | 425.93µs | 436.96µs | 4045 | n/a |
| `finance_query::cond_bench_held_for_bars` | n/a | 160.95µs | 163.18µs | 1041 | n/a |
| `finance_query::cond_bench_in_loss` | n/a | 429.74µs | 435.76µs | 4045 | n/a |
| `finance_query::cond_bench_in_profit` | n/a | 51.08µs | 53.14µs | 142 | n/a |
| `finance_query::cond_bench_is_long` | n/a | 426.86µs | 446.66µs | 4045 | n/a |
| `finance_query::cond_bench_is_short` | n/a | 35.67µs | 36.17µs | 13 | n/a |
| `finance_query::cond_bench_no_position` | n/a | 35.74µs | 36.21µs | 13 | n/a |
| `finance_query::cond_bench_stop_loss` | n/a | 44.42µs | 48.40µs | 24 | n/a |
| `finance_query::cond_bench_take_profit` | n/a | 43.06µs | 44.16µs | 13 | n/a |
| `finance_query::cond_bench_trailing_stop` | n/a | 51.15µs | 52.58µs | 92 | n/a |
| `finance_query::cond_bench_trailing_take_profit` | n/a | 50.35µs | 62.21µs | 72 | n/a |
| `finance_query::de_chart` | n/a | 9.98µs | 10.13µs | 13 | n/a |
| `finance_query::de_crypto_coins` | n/a | 33.96µs | 35.36µs | 205 | n/a |
| `finance_query::de_currencies` | n/a | 57.67µs | 58.46µs | 647 | n/a |
| `finance_query::de_edgar_facts` | n/a | 1.50ms | 1.61ms | 11899 | n/a |
| `finance_query::de_edgar_submissions` | n/a | 457.24µs | 471.29µs | 6784 | n/a |
| `finance_query::de_fear_and_greed` | n/a | 118.8ns | 121.1ns | 0 | n/a |
| `finance_query::de_fear_and_greed_crypto_history` | n/a | 1.44µs | 1.49µs | 3 | n/a |
| `finance_query::de_financials` | n/a | 21.88µs | 22.23µs | 206 | n/a |
| `finance_query::de_fred_series` | n/a | 111.91µs | 112.88µs | 873 | n/a |
| `finance_query::de_hours` | n/a | 753.3ns | 774.2ns | 10 | n/a |
| `finance_query::de_market_summary` | n/a | 32.61µs | 33.37µs | 228 | n/a |
| `finance_query::de_news` | n/a | 3.90µs | 4.03µs | 53 | n/a |
| `finance_query::de_options` | n/a | 1.10µs | 1.18µs | 6 | n/a |
| `finance_query::de_quote` | n/a | 1.09ms | 1.12ms | 8235 | n/a |
| `finance_query::de_screener` | n/a | 402.62µs | 424.39µs | 4498 | n/a |
| `finance_query::de_search` | n/a | 5.60µs | 5.87µs | 55 | n/a |
| `finance_query::de_treasury_yields` | n/a | 79.02µs | 80.71µs | 119 | n/a |
| `finance_query::de_trending` | n/a | 1.44µs | 1.46µs | 24 | n/a |
| `finance_query::dispatch_select` | n/a | 4.2ns | 4.4ns | 0 | n/a |
| `finance_query::ind_accumulation_distribution` | n/a | 4.34µs | 4.44µs | 1 | n/a |
| `finance_query::ind_alma` | n/a | 5.29µs | 5.35µs | 2 | n/a |
| `finance_query::ind_aroon` | n/a | 11.96µs | 12.22µs | 9 | n/a |
| `finance_query::ind_atr` | n/a | 11.04µs | 11.10µs | 2 | n/a |
| `finance_query::ind_awesome_oscillator` | n/a | 9.48µs | 9.54µs | 4 | n/a |
| `finance_query::ind_balance_of_power` | n/a | 2.20µs | 2.24µs | 2 | n/a |
| `finance_query::ind_bull_bear_power` | n/a | 7.73µs | 7.80µs | 3 | n/a |
| `finance_query::ind_cci` | n/a | 18.59µs | 18.75µs | 2 | n/a |
| `finance_query::ind_chaikin_oscillator` | n/a | 17.87µs | 18.10µs | 4 | n/a |
| `finance_query::ind_choppiness_index` | n/a | 21.23µs | 21.52µs | 8 | n/a |
| `finance_query::ind_cmf` | n/a | 4.34µs | 4.42µs | 2 | n/a |
| `finance_query::ind_cmo` | n/a | 5.66µs | 5.97µs | 2 | n/a |
| `finance_query::ind_coppock_curve` | n/a | 8.65µs | 8.82µs | 3 | n/a |
| `finance_query::ind_dema` | n/a | 13.34µs | 13.42µs | 3 | n/a |
| `finance_query::ind_donchian_channels` | n/a | 11.46µs | 11.61µs | 9 | n/a |
| `finance_query::ind_elder_ray` | n/a | 7.73µs | 7.81µs | 3 | n/a |
| `finance_query::ind_fibonacci_pivot_points` | n/a | 2.82µs | 2.85µs | 1 | n/a |
| `finance_query::ind_fibonacci_retracement` | n/a | 11.37µs | 11.80µs | 9 | n/a |
| `finance_query::ind_heikin_ashi` | n/a | 16.32µs | 16.54µs | 9 | n/a |
| `finance_query::ind_hma` | n/a | 15.26µs | 15.40µs | 5 | n/a |
| `finance_query::ind_ichimoku` | n/a | 33.96µs | 36.70µs | 27 | n/a |
| `finance_query::ind_keltner_channels` | n/a | 19.09µs | 19.31µs | 5 | n/a |
| `finance_query::ind_last_value` | n/a | 3.1ns | 3.3ns | 0 | n/a |
| `finance_query::ind_macd` | n/a | 22.14µs | 22.35µs | 7 | n/a |
| `finance_query::ind_mcginley_dynamic` | n/a | 13.80µs | 13.88µs | 1 | n/a |
| `finance_query::ind_mfi` | n/a | 6.98µs | 7.03µs | 3 | n/a |
| `finance_query::ind_momentum` | n/a | 130.93µs | 136.44µs | 52 | n/a |
| `finance_query::ind_momentum_single` | n/a | 584.6ns | 605.3ns | 1 | n/a |
| `finance_query::ind_moving_averages` | n/a | 95.66µs | 97.14µs | 27 | n/a |
| `finance_query::ind_parabolic_sar` | n/a | 2.35µs | 2.41µs | 1 | n/a |
| `finance_query::ind_patterns` | n/a | 111.27µs | 112.55µs | 1 | n/a |
| `finance_query::ind_pivot_points` | n/a | 3.22µs | 3.27µs | 1 | n/a |
| `finance_query::ind_roc` | n/a | 1.80µs | 1.92µs | 1 | n/a |
| `finance_query::ind_sma` | n/a | 426.34µs | 430.92µs | 1 | n/a |
| `finance_query::ind_stochastic` | n/a | 16.60µs | 17.24µs | 11 | n/a |
| `finance_query::ind_stochastic_rsi` | n/a | 27.64µs | 27.99µs | 12 | n/a |
| `finance_query::ind_supertrend` | n/a | 14.73µs | 14.96µs | 4 | n/a |
| `finance_query::ind_tema` | n/a | 19.60µs | 19.70µs | 4 | n/a |
| `finance_query::ind_trend` | n/a | 91.60µs | 95.91µs | 48 | n/a |
| `finance_query::ind_true_range` | n/a | 1.35µs | 1.36µs | 1 | n/a |
| `finance_query::ind_volatility` | n/a | 71.21µs | 72.70µs | 28 | n/a |
| `finance_query::ind_volume` | n/a | 44.46µs | 45.18µs | 14 | n/a |
| `finance_query::ind_vwap` | n/a | 4.37µs | 4.48µs | 1 | n/a |
| `finance_query::ind_vwma` | n/a | 3.29µs | 3.37µs | 1 | n/a |
| `finance_query::ind_williams_r` | n/a | 10.80µs | 11.51µs | 7 | n/a |
| `finance_query::ind_wma` | n/a | 5.06µs | 5.12µs | 7 | n/a |
| `finance_query::ind_zigzag` | n/a | 1.59µs | 1.67µs | 4 | n/a |
| `finance_query::ref_bench_accumulation_distribution` | n/a | 50.97µs | 53.13µs | 23 | n/a |
| `finance_query::ref_bench_adx` | n/a | 527.91µs | 539.80µs | 4930 | n/a |
| `finance_query::ref_bench_alma` | n/a | 555.01µs | 577.85µs | 5019 | n/a |
| `finance_query::ref_bench_aroon` | n/a | 526.44µs | 534.18µs | 4950 | n/a |
| `finance_query::ref_bench_atr` | n/a | 531.52µs | 553.06µs | 4996 | n/a |
| `finance_query::ref_bench_awesome_oscillator` | n/a | 317.37µs | 327.90µs | 2636 | n/a |
| `finance_query::ref_bench_balance_of_power` | n/a | 49.93µs | 50.50µs | 25 | n/a |
| `finance_query::ref_bench_bear_power` | n/a | 143.72µs | 148.81µs | 806 | n/a |
| `finance_query::ref_bench_bollinger` | n/a | 552.46µs | 619.91µs | 4968 | n/a |
| `finance_query::ref_bench_bull_power` | n/a | 488.01µs | 530.96µs | 4238 | n/a |
| `finance_query::ref_bench_candle_body` | n/a | 23.97µs | 28.80µs | 6 | n/a |
| `finance_query::ref_bench_candle_range` | n/a | 493.04µs | 509.88µs | 5043 | n/a |
| `finance_query::ref_bench_cci` | n/a | 315.26µs | 329.37µs | 2605 | n/a |
| `finance_query::ref_bench_chaikin_oscillator` | n/a | 68.48µs | 71.55µs | 26 | n/a |
| `finance_query::ref_bench_choppiness_index` | n/a | 546.94µs | 703.85µs | 5002 | n/a |
| `finance_query::ref_bench_close` | n/a | 695.64µs | 1.06ms | 5043 | n/a |
| `finance_query::ref_bench_cmf` | n/a | 52.28µs | 53.19µs | 25 | n/a |
| `finance_query::ref_bench_cmo` | n/a | 299.38µs | 303.87µs | 2598 | n/a |
| `finance_query::ref_bench_coppock_curve` | n/a | 312.44µs | 323.58µs | 2559 | n/a |
| `finance_query::ref_bench_dema` | n/a | 524.35µs | 533.35µs | 4875 | n/a |
| `finance_query::ref_bench_donchian` | n/a | 552.98µs | 571.51µs | 4976 | n/a |
| `finance_query::ref_bench_elder_bear_power` | n/a | 143.61µs | 147.33µs | 806 | n/a |
| `finance_query::ref_bench_elder_bull_power` | n/a | 493.03µs | 507.69µs | 4238 | n/a |
| `finance_query::ref_bench_ema` | n/a | 522.07µs | 541.05µs | 4963 | n/a |
| `finance_query::ref_bench_gap_pct` | n/a | 260.15µs | 265.88µs | 2489 | n/a |
| `finance_query::ref_bench_high` | n/a | 494.74µs | 508.83µs | 5043 | n/a |
| `finance_query::ref_bench_hma` | n/a | 529.21µs | 537.87µs | 4957 | n/a |
| `finance_query::ref_bench_htf` | n/a | 594.81µs | 605.15µs | 7039 | n/a |
| `finance_query::ref_bench_htf_region` | n/a | 597.77µs | 603.59µs | 7039 | n/a |
| `finance_query::ref_bench_ichimoku` | n/a | 576.97µs | 651.04µs | 4836 | n/a |
| `finance_query::ref_bench_ichimoku_custom` | n/a | 574.31µs | 591.17µs | 4836 | n/a |
| `finance_query::ref_bench_is_bearish` | n/a | 24.04µs | 24.37µs | 6 | n/a |
| `finance_query::ref_bench_is_bullish` | n/a | 24.07µs | 24.66µs | 6 | n/a |
| `finance_query::ref_bench_keltner` | n/a | 567.00µs | 577.92µs | 4972 | n/a |
| `finance_query::ref_bench_low` | n/a | 490.80µs | 509.24µs | 5043 | n/a |
| `finance_query::ref_bench_macd` | n/a | 326.62µs | 511.43µs | 2541 | n/a |
| `finance_query::ref_bench_mcginley` | n/a | 530.88µs | 683.49µs | 4963 | n/a |
| `finance_query::ref_bench_median_price` | n/a | 494.00µs | 525.98µs | 5043 | n/a |
| `finance_query::ref_bench_mfi` | n/a | 527.31µs | 539.57µs | 4998 | n/a |
| `finance_query::ref_bench_momentum` | n/a | 293.44µs | 309.20µs | 2552 | n/a |
| `finance_query::ref_bench_obv` | n/a | 62.19µs | 63.88µs | 30 | n/a |
| `finance_query::ref_bench_open` | n/a | 489.92µs | 497.04µs | 5043 | n/a |
| `finance_query::ref_bench_parabolic_sar` | n/a | 554.45µs | 575.91µs | 5056 | n/a |
| `finance_query::ref_bench_price` | n/a | 491.36µs | 499.43µs | 5043 | n/a |
| `finance_query::ref_bench_price_change_pct` | n/a | 274.18µs | 278.04µs | 2489 | n/a |
| `finance_query::ref_bench_relative_volume` | n/a | 535.51µs | 541.03µs | 4949 | n/a |
| `finance_query::ref_bench_roc` | n/a | 294.59µs | 308.80µs | 2587 | n/a |
| `finance_query::ref_bench_rsi` | n/a | 526.02µs | 539.78µs | 4994 | n/a |
| `finance_query::ref_bench_sma` | n/a | 519.20µs | 527.29µs | 4963 | n/a |
| `finance_query::ref_bench_stochastic` | n/a | 562.38µs | 587.41µs | 4987 | n/a |
| `finance_query::ref_bench_stochastic_rsi` | n/a | 561.01µs | 601.29µs | 4831 | n/a |
| `finance_query::ref_bench_supertrend` | n/a | 569.65µs | 594.13µs | 5021 | n/a |
| `finance_query::ref_bench_tema` | n/a | 520.88µs | 527.98µs | 4781 | n/a |
| `finance_query::ref_bench_true_range` | n/a | 525.99µs | 533.79µs | 5059 | n/a |
| `finance_query::ref_bench_typical_price` | n/a | 526.02µs | 549.02µs | 5043 | n/a |
| `finance_query::ref_bench_volume` | n/a | 495.85µs | 511.96µs | 5043 | n/a |
| `finance_query::ref_bench_vwap` | n/a | 524.76µs | 535.97µs | 5060 | n/a |
| `finance_query::ref_bench_vwma` | n/a | 521.19µs | 547.23µs | 4964 | n/a |
| `finance_query::ref_bench_williams_r` | n/a | 61.04µs | 99.65µs | 29 | n/a |
| `finance_query::ref_bench_wma` | n/a | 521.02µs | 535.88µs | 4969 | n/a |
| `finance_query::risk_beta` | n/a | 68.98µs | 70.09µs | 0 | n/a |
| `finance_query::risk_calmar` | n/a | 15.4ns | 16.4ns | 0 | n/a |
| `finance_query::risk_historical_cvar` | n/a | 311.47µs | 315.58µs | 2 | n/a |
| `finance_query::risk_historical_var` | n/a | 2.79ms | 2.86ms | 2 | n/a |
| `finance_query::risk_information_ratio` | n/a | 38.93µs | 39.20µs | 1 | n/a |
| `finance_query::risk_kelly_criterion` | n/a | 3.79µs | 4.03µs | 16 | n/a |
| `finance_query::risk_max_drawdown` | n/a | 9.04µs | 9.09µs | 1 | n/a |
| `finance_query::risk_omega_ratio` | n/a | 34.47µs | 34.67µs | 0 | n/a |
| `finance_query::risk_parametric_cvar` | n/a | 34.53µs | 34.97µs | 0 | n/a |
| `finance_query::risk_parametric_var` | n/a | 34.55µs | 37.49µs | 0 | n/a |
| `finance_query::risk_sharpe` | n/a | 34.63µs | 34.99µs | 0 | n/a |
| `finance_query::risk_sortino` | n/a | 34.62µs | 38.65µs | 0 | n/a |
| `finance_query::risk_tracking_error` | n/a | 39.07µs | 40.95µs | 1 | n/a |
| `finance_query::risk_ulcer_index` | n/a | 203.21µs | 205.78µs | 2 | n/a |
| `finance_query::risk_win_loss_stats` | n/a | 59.13µs | 60.53µs | 25 | n/a |
| `finance_query::rss_parse` | n/a | 5.70µs | 6.21µs | 48 | n/a |
| `finance_query::score_news` | n/a | 75.84µs | 77.33µs | 976 | n/a |
| `finance_query::score_transcript` | n/a | 4.82ms | 4.89ms | 42100 | n/a |
| `finance_query::ser_currencies` | n/a | 15.77µs | 16.44µs | 8 | n/a |
| `finance_query::stream_deserialize` | n/a | 1.26µs | 1.39µs | 4 | n/a |
| `finance_query::stream_serialize` | n/a | 1.00µs | 1.13µs | 4 | n/a |
| `finance_query::ticker_chart_then_cached` | n/a | 1.29µs | 1.33µs | 20 | n/a |
| `finance_query::ticker_quote_then_cached` | n/a | 11.60µs | 12.27µs | 4 | n/a |
| `finance_query::tickers_batch_quote_then_cached` | n/a | 9.74µs | 10.14µs | 16 | n/a |
| `finance_query::translate_dictionary` | n/a | 1.96µs | 2.08µs | 49 | n/a |
| `finance_query::translation_set_backend` | n/a | 23.5ns | 26.2ns | 1 | n/a |
| `finance_query::translation_translate` | n/a | 3.77µs | 3.87µs | 79 | n/a |
| `finance_query::translation_translate_with` | n/a | 3.51µs | 3.68µs | 77 | n/a |
